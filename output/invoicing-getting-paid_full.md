...
## 2. What is Happening with Tips in Jobber?

**Author:** JobberUser (Contributor 2)
**Posted:** 2026-04-08
**Views:** 54 | **Likes:** 1 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/what-is-happening-with-tips-in-jobber/9979
...
Hi JobberUser​ Thanks for bringing this up, we appreciate you sharing your experience here. We’d love to better understand your workflow so we can share clear, actionable feedback with our Product team. Could you share a bit more about how you’re currently handling tips, and what you would ideally expect to see in Jobber? For example, how you’d want tips to be tracked, separated, or reported for accounting purposes. Any additional details you can provide will really help us make things we can do in this area.

---

## 3. Where did the "COLLECT" button go from the invoice page?!?!

**Author:** ActualJeff (Contributor 3)
**Posted:** 2026-04-10
**Views:** 89 | **Likes:** 1 | **Comments:** 3
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/where-did-the-collect-button-go-from-the-invoice-page/10085

### Content

Jobber apparently just pushed out a redesign of the Invoice UI, and where there used to be a "Collect" button (right next to "More..."), but now it's been gone for several days. I've reloaded several invoices, and unless I click the down arrow for "Save Invoice and..." I can't figure out how to collect money on open invoices, either to run a CC payment through Jobber payments, or to enter an external cash or check payment. Seriously Jobber, this worked last week. Why keep redesigning and breaking things?
...
It’s still showing on my end. You may want to clear your browser cookies or update your browser. Try signing out and logging back in as well.
...
JOBBER COMMUNITY TEAM Hi Jeff, if you're still unable to see the "Collect Payment" button, please reach out to our Success Team directly as they are best equipped to assist here!
...
For any that also had this issue, leaving some bread crumbs for posterity... Solved. It just took waiting on hold for Jobber Support for 40 min, but Simba was very understanding and helpful, solved my problem Turns out that the Dev team decided there should be an extra, non-intuitive step. If you save an invoice without collecting at that moment, you now have to click the "..." /MORE button on the invoice page, then "MARK AS SENT", and the "COLLECT" button reappers

---

## 4. Jobber jobs to QBO projects integration

**Author:** RedAlder (Contributor 2)
**Posted:** 2026-01-08
**Views:** 292 | **Likes:** 5 | **Comments:** 8
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/jobber-jobs-to-qbo-projects-integration/7937

### Content

Has anyone tried to extend the QBO Jobber integration to link a Jobber Job with a QBO project? We are an electrical contractor and have numerous suppliers and many components we use. All of them are entered into QBO. Our field team uses Jobber. I want to use the QBO projects to track project profitability. Which means three enhancements are needed: 1 - Jobber Job creation triggers a QBO project for the same customer. 2 - Time sheets from Jobber need to be updated to tag the customer and Job in QBO 3 - invoices would need to also be linked to from project to job. The job numbers in jobber could be used in QBO to create the linkage e.g. they can be used in the project name.
...
to WiringByron I got you WiringByron​!
...
Jerry, your frustration with the Job Form bottleneck is 100% valid—it’s a massive time-sink to download and re-upload files just to get paid. We built a Stability Layer for Jobber that solves this exact "paperwork mountain." Our system automatically attaches the completed Job Form (including site photos) directly to the Invoice PDF the moment the job is closed. No external folders, no extra steps. Regarding your multi-property issue: we’ve fixed the data-mapping gap so the Service Address stays locked to the Invoice, even if the Billing Address is different. Also, for your door stickers, we can generate those unique identifiers and link them directly to a "Google-first" review trigger. Since you're considering a move to HouseCall, I’d love to show you how we can fix these Jobber deal-breakers for you in 5 minutes.

---

## 6. Advice adding the credit card service fee to invoices

**Author:** Chloe (Contributor 3)
**Posted:** 2025-05-08
**Views:** 26 | **Likes:** 4 | **Comments:** 36
...
to Chloe Chloe, I know this is an older thread, but the 'administrative mess' you described is still a massive pain point in 2026. Coming from a tech leadership background myself, I couldn't stand the manual workarounds either. We’ve actually developed a technical bridge for Jobber that automates the surcharge reconciliation and fixes the tax sync issues in QuickBooks that you mentioned. Since you're handling operations for multiple companies through Stomata Ops, I’d love to get your expert take on how we’ve structured this automation. It’s built specifically to eliminate the 'woof' moments in the back office. Cheers!
...
**Author:** Jerry_Kobylt (Contributor 2)
**Posted:** 2025-10-08
**Views:** 314 | **Likes:** 3 | **Comments:** 9
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/changing-properties-on-invoices/6079

### Content

It's very cumbersome and difficult to change the property / address on an invoice if it is not correct from the very beginning. This is very annoying. Please add an option to choose a different property or add a new address in all areas an address is shown. Make it easy to change.
...
+1 to this. Not an issue I run into often, but seems near impossible when needed. Also agree, Jobber seems to keep redesigning and moving things without fixing any of the many bugs, I'm also considering other options than Jobber now
...
We run into this a lot too, especially in wildlife work where the service address can change from initial inspection to final invoice. One thing that’s helped us is double-checking and locking in the correct property during the job setup stage before converting to invoice, but I agree it would be a big improvement if Jobber made it easier to update without friction. It would be especially helpful for companies handling multiple properties or tenants under one client. Curious if anyone has found a smoother workflow around this?

---

## 8. Deposit for multi visit job

**Author:** BlueSkies (Contributor 3)
**Posted:** 2026-04-08
**Views:** 104 | **Likes:** 0 | **Comments:** 3
...
## 9. Is there a limit how much you can charge using Jobber Payments?

**Author:** PestFreeCanada (Contributor 5)
**Posted:** 2026-03-08
**Views:** 138 | **Likes:** 1 | **Comments:** 4
...
## 10. Can I create one invoice for multiple locations?

**Author:** PestFreeCanada (Contributor 5)
**Posted:** 2026-03-08
**Views:** 146 | **Likes:** 1 | **Comments:** 3
...
Hi PestFreeCanada​ Yes, you can absolutely do this. To create one invoice that includes multiple properties for the same client, go to the client profile, click More Actions, then select Create Invoice. From there, you will see the option to bulk invoice all of that client’s properties onto one invoice. This will generate a single invoice with each location itemized, so your client only needs to receive and print one document, while still clearly showing the breakdown by property.
...
Hey QHS! As long as you are on the new QBO integration, the payment should sync over with the full amount, roughly 2 business days later, the "payout" will sync, this will be the deposit amount after the fees are removed, as long as you have this set up to match your checking account used for Jobber payments, no reconciliation is needed. Quickbooks should then match the deposit to the payment and the fee to a separate expense account. It is important that you do not try to match the deposit manually, as it will not reconcile. Here is a Help Center Article that explains how this works.

---

## 12. new invoice numbering system

**Author:** accounts (Contributor 2)
**Posted:** 2026-03-08
**Views:** 125 | **Likes:** 0 | **Comments:** 2
...
**Author:** BlueSkies (Contributor 3)
**Posted:** 2026-03-08
**Views:** 98 | **Likes:** 1 | **Comments:** 3
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/invoice-frequency/8730

### Content

Im almost positive im just missing it. Is there any way to change the default invoice setting. I bill per visit. Not monthly. Yes i can change it on the job screen. Just one less click. And basically for the very small few that i bill out monthly, it is a change from normal so i remember that part.
...
**Posted:** 2025-07-08
**Views:** 137 | **Likes:** 1 | **Comments:** 2
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/process-payments/4618

### Content

Hello everyone, Does anyone know how long Jobber takes to Process a payment? I collected my first payment through Jobber here on Tuesday and it is now Friday and still stating processing. Just curious how long that will take? Thanks!
...
## 15. Why does Jobber prompt me to add my email when sending invoices from my phone?

**Author:** PestFreeCanada (Contributor 5)
**Posted:** 2026-03-08
**Views:** 105 | **Likes:** 0 | **Comments:** 1
...
## 16. How can businesses offer prepaid discounts without accepting card payments on specific quotes?

**Author:** BlueSkies (Contributor 3)
**Posted:** 2026-02-08
**Views:** 100 | **Likes:** 0 | **Comments:** 1
...
## 18. Why is invoice email not sending?
...
## 19. Xero intergration

**Author:** Tailoredcleans (Contributor 2)
**Posted:** 2025-05-08
**Views:** 245 | **Likes:** 2 | **Comments:** 4
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/xero-intergration/1208

### Content

When integrating with xero, does the customer recieve the invoice from xero or jobber? I currently invoice via xero, I want to smoothen my work flow and integrate but thought I'd ask here first, how was the process? (Don't want to mess my books up and create extra work for myself) TIA 👌
...
## 20. Did you know you can adjust the due date for an invoice?
...
## 21. A real question about cash payments.
...
## 24. How to add shop supplies to an invoice as a percentage of the total of the invoice?

**Author:** EESi (Contributor 2)
**Posted:** 2025-08-09
**Views:** 71 | **Likes:** 0 | **Comments:** 3
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/how-to-add-shop-supplies-to-an-invoice-as-a-percentage-of-the-total-of-the-invoi/5423

### Content

Pretty standard invoicing question... trying to add shop supplies to invoicing to cover all the small items not worth itemizing... How do you set that up as a line item in Jobber?
...
To add shop supplies as a percentage in Jobber, you can: (1) Create a “Shop Supplies” item in Products & Services with markup (e.g. 5%), then add it to invoices; (2) Use the discount tool with a negative value (e.g. -5%) as a surcharge and rename it “Shop Supplies”; or (3) Manually add a line item and calculate 5% of the subtotal. Best practice: Clearly show the charge in estimates to avoid client confusion.
...
i have actually tried that ..and it wont accept a negative discount so you have to calculate it manually every time..
...
Hi EESi​ Thanks for the question! Rather than adding a separate “Shop Supplies” line item to every invoice, you might find it easier to use the markup feature in your Products and Services list. You can add a markup percentage to your existing items to help cover overhead costs shop supplies and other small materials that aren’t worth itemizing individually. This way, those costs are automatically built into your pricing without needing to add an extra line to every invoice. Can you tell me a bit more about what you’re trying to achieve? I’m curious why adding a markup to your Products and Services wouldn’t accomplish what you’re looking for.
...
Hi BlueSkies​ Thanks for reaching out! You’re right—it would definitely make things easier for both you and your customers if all outstanding balances could be grouped together. When you use Batch Invoicing, Jobber will automatically combine all outstanding invoice reminders for a client into one new invoice. You can do this by going to the client’s profile and selecting: More Actions → Invoice, then choose the jobs or visits you’d to include. If the invoices have already been created, the simplest option is usually to add the remaining line items to one invoice. However, you could also delete the existing invoices and create a new invoice reminder that includes all the work together. This should make it easier for your clients to pay everything at once and keep your records tidy!

---

## 26. Invoice Automations

**Author:** josegrados (Contributor 2)
**Posted:** 2025-10-27
**Views:** 34 | **Likes:** 2 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/invoice-automations/7341

### Content

Does anyone know how to create an Invoice automation to alert the client BEFORE the INV is due? My invoices are NET 14, so I would to create an automation that send the customer an email/ text saying something "Hello, your INV is due in XX days, please make sure submit your payment before it is due". That way I can avoid having LATE invoices. The earliest I see you can send an INV automation is the day the INV is due. Thank you.
...
Is it possible to just change your payment terms to "Due upon receipt" ? josegrados​ We give customers 24 hours to pay and then we charge their card if we do not receive the final payment.

---

## 27. Job attachments BIGGER

**Author:** FFcrpntry (Contributor 2)
**Posted:** 2025-10-27
**Views:** 22 | **Likes:** 1 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/job-attachments-bigger/7303

### Content

Hello, could you please adjust the attached photos section to display larger previews? It would help me better visualize and select the photo I need. jade Hey There! Thank you so much for your feedback, we have passed this along to our Product Development team. To help you better identify which attachments you need to send, I recommend renaming the file for an easier way to attach what you need. We appreciate your suggestion, and thanks for bringing this to the community!
...
## 28. Jobber's New Sales Pipeline

**Author:** FredHodgeJr (Jobber Ambassador)
**Posted:** 2025-10-27
**Views:** 253 | **Likes:** 4 | **Comments:** 3
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/jobbers-new-sales-pipeline/7129

### Content

Who else is excited about the new Sales Pipeline?! This is something we have wanted for years.
...
LFG!!! I hope Jobber continues to expand on this so we can eliminate having another CRM dedicated to sales. Right now we’re using Apollo.io to run sequences and track calls/emails.
...
to ryaantuttle Yes! I am coming back to Jobber after a hiatus, and for the meantime will need to supplement our CRM side of things with PipeDrive externally. With this sales pipeline and hopefully email convos within Jobber (every basic CRM has this guys!!), it would be a killer all in one solution.
...
JOBBER COMMUNITY TEAM Thanks so much for sharing!
...
Absolutely brilliant!!!! SKAdminServices​ I HOPE a lot of people see this post as I know how helpful it will be until Jobber makes those changes on the product side of things. BRAVO!!
...
This is still a manual process though, right? Meaning we still have to ask the customer what they will be paying with, then populate the invoice with the fee?
...
to StaceySmith Hi StaceySmith​ That’s correct — this is still a manual process. At this time, Jobber doesn’t recommend using this method, as we’re aware of various issues that can occur as a result, including potential syncing problems with QuickBooks Online. We’d love to hear more about your needs around surcharging so we can take them into consideration for future updates to Jobber. Your feedback helps us continue improving the product to better support your business. Please reach out to our Success team at 1-888-721-1115 option 1 or support@getjobber.com

---

## 30. New Invoice Feature

**Author:** Jbryan3942 (Contributor 2)
**Posted:** 2025-10-27
**Views:** 39 | **Likes:** 0 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/new-invoice-feature/7093

### Content

Great improvement on being able to apply a payment to multiple invoices, however, in Lawn Care we do a lot of prepayments prior to our season and at this time Jobber does not have a definitive way to apply that money correctly. With the new feature, it would be a start if we could apply a payment to future invoices. So, when the invoices are created for the season, we can apply the payment made for the whole season. LAWN CARE PAYMENT DETAILS PAYMENT SCHEDULES
...
Hi Jbryan3942​ Thanks so much for taking the time to share this feedback. It’s great to hear that applying payments to multiple invoices is already helping, and I really appreciate you highlighting how prepayments are such a common part of workflows in lawn care. At this time, Jobber doesn’t yet have a way to directly apply a prepayment toward future invoices, but understanding your use case in more detail will help us explore how to best support this type of workflow. I’d encourage you to give our Success Team a call at 1-888-721-1115 (option 1). They’ll be glad to talk through your process with you and capture your feedback directly so our product team has a clear picture of how this could be most impactful. Jobber is built by the voice of our customers, and insights yours help shape the improvements we make. Thank you again for sharing how you’d to see this evolve.

---

## 31. Customer Q: Is there a way to create an automated invoice reminder before an invoice is due?

**Author:** Paige (Jobber Product Team)
**Posted:** 2025-10-27
**Views:** 16 | **Likes:** 0 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/customer-q-is-there-a-way-to-create-an-automated-invoice-reminder-before-an-invo/7107

### Content

JOBBER PRODUCT TEAM Thanks for the question. At this time, no. You can only send an invoice follow-up once the invoice is due. I have passed this feedback to the Product Team for their consideration, as we know this would be a valuable feature! INVOICE FOLLOW-UPS
...
## 32. Does Jobber Support Centralized Multi-Unit (Franchise) Financial Reporting & Management?

**Author:** EpicSeptic2025 (Contributor 2)
**Posted:** 2025-09-27
**Views:** 47 | **Likes:** 0 | **Comments:** 4
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/does-jobber-support-centralized-multi-unit-franchise-financial-reporting--manage/6098

### Content

We're planning to scale our business to multiple location's and want to confirm whether Jobber supports multi-unit or franchise-style operations. Specifically: -Does Jobber offer features that allow centralized financial reporting for multiple locations? -Is there a central hub where HQ or administrators can view consolidated KPIs, royalties, invoices ,and payments across locations? -Can each location operate as its own account with separate branding and operations, while still feeding into a central reporting view? jade Hey there! Thank you for this question. If multiple Jobber accounts are connected through a franchise, then admin users who are on all accounts can pull reporting for all of those accounts. If an admin user is a user on one of the franchised accounts but not the other, they can only pull reports from the Jobber account they are associated with. For more information on how this works, please check out this Help Center Article.
...
Hey there! Thank you for this question. If multiple Jobber accounts are connected through a franchise, then admin users who are on all accounts can pull reporting for all of those accounts. If an admin user is a user on one of the franchised accounts but not the other, they can only pull reports from the Jobber account they are associated with. For more information on how this works, please check out this Help Center Article.
...
Check out the Crew Insight integration. Consolidated reports, KPIs, metrics, analytics is available across multiple accounts.
...
So you need to get a separate Jobber account for each location?
...
## 34. Invoice Automation

**Author:** ReadySetMow--1 (Contributor 2)
**Posted:** 2025-07-27
**Views:** 48 | **Likes:** 1 | **Comments:** 3
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/invoice-automation/4988

### Content

So I use a company that does billing for a lot of my lawn customers so after I complete the job I have it create a invoice but then I have to collect payment and pick the type does anyone else have a situation that were we know we get the payment so I would it to have a option for automation for invoicing so lets say you complete the job and it automatically invoices and collect payment of the type you set it up for to save time in the field krista Hi ReadySetMow--1​ Thanks for the question, ryaantuttle​ is right! Jobber has automatic invoicing and payments to save you time in the field. Here is our help article on how to set it up. If you have more questions or would a demo, please feel free to reach out to our Success team at 1-888-721-1115 option 1
...
Hi ReadySetMow--1​ Thanks for the question, ryaantuttle​ is right! Jobber has automatic invoicing and payments to save you time in the field. Here is our help article on how to set it up. If you have more questions or would a demo, please feel free to reach out to our Success team at 1-888-721-1115 option 1
...
Yes! Jobber has ALL of these features and more. What plan option are you currently using?
...
Using Jobber payments is great! We have also been utilizing the new ACH payment feature, especially on large jobs, turning off the debit/credit card option and only choosing ACH payments for certain invoices saves on processing fees!

---

## 35. Collecting multiple/additional deposit payments

**Author:** apexhomeworks (Contributor 2)
**Posted:** 2025-06-27
**Views:** 32 | **Likes:** 1 | **Comments:** 2
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/collecting-multipleadditional-deposit-payments/4280

### Content

We often have customers that want to make multiple payments towards their deposit and additional payments beyond their deposit. Is there a way to accepts these payments on a quote? I don't see the option for progress invoicing in Jobber Labs to create a payment schedule which seems to be a viable solution that I found searching in Help Center.
...
You can use "Payment Schedule" when creating a "Quote" in Jobber.
...
## 37. Invoice/Quote Scheduled Sending

**Author:** vlang (Contributor 2)
**Posted:** 2025-05-27
**Views:** 79 | **Likes:** 3 | **Comments:** 4
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/invoicequote-scheduled-sending/3854

### Content

Are there any ways to select a specific time and/or date for an invoice or quote to be sent? I would love the ability to send invoices in the evening and weekends when I am not working in the field, however I worry about customer experience in off hours and invoices getting lost over the weekend. Does anybody else want this functionality or has anyone come up with a work around? INVOICING jade Hey Vlang, thanks for the question. In Jobber, you can set up automatic invoicing and payments if you have the client's card on file and if the job is recurring. For more information on this, check out this Help Center article. If you do not wish to collect automatic payments, you can set up the job to remind you to invoice on a custom schedule. While this does not create the invoice, it will prompt you to invoice and give you the option to do batch invoicing so you can create multiple invoices in just a few clicks. To learn more about this feature, check out this article. If you have any questions about the information I shared, please contact our Success Team 888-721-1115 ext 1 or email mailto:support@getjobber.com
...
83effone I think Vlang may be asking more about postponing sending quotes/invoices. If so, I am very interested in a feature this. I work on quotes/scheduling jobs late at night and leave early in the morning. I would love to schedule the quote/appt/etc to send at 8am the following day. A set time window of client communication would be fine too. For example, a setting that allows comms to happen only between 7am and 8pm so I'm not waking up my clients.
...
to 83effone 83effone, exactly what I was thinking. I share your worry of waking/bothering clients in off hours. In Outlook email, if I click send after 5:00pm it prompts me if I would the email delivered next day during working hours (8:00am-5:00pm). I think this feature would be great in Jobber.
...
Hey Vlang, thanks for the question. In Jobber, you can set up automatic invoicing and payments if you have the client's card on file and if the job is recurring. For more information on this, check out this Help Center article. If you do not wish to collect automatic payments, you can set up the job to remind you to invoice on a custom schedule. While this does not create the invoice, it will prompt you to invoice and give you the option to do batch invoicing so you can create multiple invoices in just a few clicks. To learn more about this feature, check out this article. If you have any questions about the information I shared, please contact our Success Team 888-721-1115 ext 1 or email mailto:support@getjobber.com
...
I think this is a great idea, especially when you are notifying the client via text message and your don't want to disturb them. (I don't think that is a problem with email.) I have an automation set up with my company that mimics a real person reaching out based on the day and time of day. For example, when a new lead comes in if it "during business hours" my automation engages within 15 minutes. If it is after hours it waits until the next day's business hours start as an example. It sounds something this would work for you if Jobber had a setting that enabled you to "only send messages during business hours". For now, maybe the process would be to add the quote, etc. to a list that a VA could handle sending the next day during a time that you want the notifications to go out.

---

## 38. Deposit for cancellations

**Author:** LukeE (Contributor 3)
**Posted:** 2025-03-27
**Views:** 58 | **Likes:** 3 | **Comments:** 6
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/deposit-for-cancellations/2521

### Content

I have been trying to figure out a way to collect a deposit in case the client cancels last minute or is a no show. You can collect a deposit for a quote, but not for a regular job or for an online booking. This seems a very obvious feature that simply doesn't exist. I've tried a workaround - generating an invoice, then changing the line item to "deposit" and then collecting payment from stored CC, but then you have to remember to record that on the invoice once the job is complete. This is a huge hassle and opens up the possibility that I forge to apply the deposit in the final invoice. I don't understand why jobber doesn't allow us to collect a deposit on every job even if it wasn't a quoted job. Anyone know a good workaround? To jobber support, PLEASE add this as a feature. I was hoping this would be in the spring product update but it wasn't. It just seems such an obvious thing to have. Many other online booking/scheduling software has this. Why hasn't jobber added this as a feature?
...
Update: After playing around a bit I realized the following: Rather than collect the deposit up front, I can collect the credit card into up front and add verbiage in my service agreement that says if they cancel last minute or are a no show, then I'll charge their card after the fact. I'd just have to replace the line items on the job with one line item called "cancellation fee" then create an invoice, mark as sent, then collect payment. It would be great if jobber would write a few lines of code to make this easier, but this seems to be a good workaround. Anyone else have any thoughts?
...
JOBBER COMMUNITY TEAM Hi Luke, thanks for sharing this with the community. I have voiced this to our Success Team so they can pass it along to our Product Team! We're glad to hear that a workaround was sorted, but curious to hear from other users and their experience.
...
You can automate sending a service agreement using zapier and sign now. Email me if you want more info on how to set that up. help@mount-it-atx.com
...
## 39. What percentage do you charge upfront

**Author:** customtackboxes (Contributor 2)
**Posted:** 2025-05-27
**Views:** 28 | **Likes:** 1 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/what-percentage-do-you-charge-upfront/3800

### Content

I build custom tack boxes in horse barns what percentage should I ask for upfront to start the job CONSTRUCTION
...
Depends on TWO factors... 1). State Laws. Check those first. Most states mandate how much you can take for a deposit for a project 2). Material Cost. How much are your materials? You'll at least want to cover the cost of your materials upfront. My State Law states I cannot take any more than 1/3 third upfront. However, if the materials cost more than 1/3 I can ask more "upfront". As your business grows, you'll want to start charging more "upfront" to cover the higher cost of overhead.

---

## 40. Payment on invoice of Total Outstanding Balance

**Author:** Crushr_Jon (Contributor 2)
**Posted:** 2025-05-27
**Views:** 27 | **Likes:** 3 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/payment-on-invoice-of-total-outstanding-balance/3776

### Content

I offer a recurring service to my customers, some of them accumulate two or three unpaid invoices. Is there a way for customers to pay off the total outstanding balance for all invoices at once? Seems that Jobber only allows individual payments for each invoice. For example, if a customer has three $400 invoices, they should be able to make a single $1,200 payment for the balance on the most recent invoice. It would be particularly helpful when customers call to pay their total balance over the phone but have multiple invoices. Currently I have to process their credit card on each invoice, which is frustrating for both me and the customers. Providing an option for customers to pay their total outstanding balance in a single transaction should available.
...
Hello Crushr Jon! Thank you for the question. There is not currently a way in Jobber to spread out bulk payments onto multiple invoices. I can see how you and other customers would benefit from a feature this, and we have submitted this feedback to the Product Development team. In the meantime, we have a few suggestions. One recommendation is to create an invoice for the total amount owed, collect the payment, and close the outstanding invoices without payment. This will mark the invoices as paid, however, it will not change the account balance on the client profile. Another suggestion is to request to save the client's card on file, so you can charge the amount owed as needed. If you have any questions or feedback, please contact our Success Team 888-721-1115 ext 1 or email mailto:support@getjobber.com.

---

## 41. Get Products and services in separate lines on the invoice and get a price book or see our materials

**Author:** PLUMR (Contributor 2)
**Posted:** 2025-05-27
**Views:** 41 | **Likes:** 3 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/get-products-and-services-in-separate-lines-on-the-invoice-and-get-a-price-book-/3773

### Content

Can we Please Get Products and services in separate lines on the invoice and get a price book or see our materials within the app on mobile INVOICING
...
Hi PLUMR​ Is the idea services are in one block and products in another? We're always evolving based on customer feedback, so we’d love to hear how this setup could help your workflow and client experience. Feel free to reach out to our Success team at 1-888-721-1115 (option 1) or support@getjobber.com — we’ll make sure your feedback gets to the right folks! 🙌

---

## 42. Jobber Bug - Invoice Reminders for Cancelled Jobs

**Author:** ActualJeff (Contributor 3)
**Posted:** 2025-02-27
**Views:** 136 | **Likes:** 2 | **Comments:** 5
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/jobber-bug---invoice-reminders-for-cancelled-jobs/2174

### Content

I've been using Jobber for about 2 years, pretty happy with it overall. I'm a one-man company, doing in-home appliance repair. I've noticed some bugs. Right now I'm going back through old "action required" jobs. Mostly jobs that booked and later cancelled before the day of the appt. There are no charges on the job, zero line items shown, yet when I close the job it still creates an invoice reminder. I know I can delete the reminder, but it's a pain. Is there any reason why a job with $0 in charges shown should automatically create an invoice reminder when its closed? Thank you! -Jeff Ryan APPLIANCE REPAIR INVOICE FOLLOW-UPS
...
to krista Krista, thanks for the a minute ago. To be clear, this is an obvious bug, but you're telling me it's a feature? It is not. Send this up the food chain. There's no reason for $0 Jobs should trigger a balance due reminder to the client or lodge an 'invoice reminder' when the dollar amt is zero. Admit it, that's a bug
...
Sorry I don’t have an answer. I’m brand new to Jobber. Just figuring this out. Doing Appliance Repair & Installation though - 1 man band. love to hear what you /dislike thus far with Jobber. Also… are you doing warranty work or just local repairs through general ads/your network?
...
Realized I didn't answer your first question, tl;dr Jobber is... fine. It's not great, and the support staff doesn't seem to have any mechanism to actually improve the product, but it's still good enough that I pay for it and continue using it. For context, I'm running 4-5 calls/day, and the appliance shop that I work with handles scheduling and data entry into Jobber I created a spreadsheet with gripes about Jobber. I haven't shared it with them, because everytime I reach out to chat or support the agents seem to find a way of telling me that the bug I'm reporting is actually a feature, seem to have zero urgency in actually fixing it. One example, if you want to send a customer notes from your visit on letterhead (to male it look 'official' as opposed to sending a typed email), but not charge any money for the visit (say it's a callback or wty call), the only way I've found to do that is to create and send a $0 "invoice", but jobber still treats that $0 invoice as a receivable, and sends a payment reminder to the customer after 30 days unless you opt to collect a '$0 cash payment.' That's clearly a bug, but jobber support told me that it was a feature because of how committed jobber is to making sure we get payed ($0 in this case) Here's a link to the spreadsheet of jobber bugs I've been tracking (loosely) https://docs.google.com/spreadsheets/d/1VSvHDwHIHf1Horz7zFh7TGUdrktI2jr2gVm1zuPSwPg/edit?usp=sharing

---

## 43. Reconciling jobber payouts

**Author:** NConway (Contributor 3)
**Posted:** 2025-04-27
**Views:** 43 | **Likes:** 2 | **Comments:** 2
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/reconciling-jobber-payouts/3049

### Content

Just curious to know what everyone’s process is with reconciling jobber payouts? Ours is synced with quickbooks so the deposits just happen on the backend automatically when we receive the payments in jobber which is so nice but I also feel I should probably set a cadence to go in and double check the deposits to be sure the correct amount (minus transaction fees) are getting credited to our bank account. Does anyone do this and if so can you share your process?
...
Hello NConway! Thanks for the question. Having your payouts sync to your Quickbooks Online is a great way to reconcile, and it separates the fee into an expense account for you. If you were looking for a way to cross-reference the reconciliation in QuickBooks to the information in Jobber, I recommend using the Jobber Payments Payout Report as a tool. If you have any questions on this, our Success Team would be happy to help! You can call us at 888-721-1115 ext 1, email mailto:support@getjobber.com or start a live chat by going to the ? > chat with us.
...
to jade Hi Jade, about jobber reconciliation with QBO, Jobber gets the information that the invoice was paid, however dos not bring in the payment amount into the client's billing history. This make us have to manually add payments so we can have an accurate account statement to send to clients. Is there anyway for Jobber to automatically get payments from QBO into the clients billing history?

---

## 44. Let’s Talk Invoice Follow-Ups—Email or Text?

**Author:** SusanC (Contributor 2)
**Posted:** 2025-02-27
**Views:** 147 | **Likes:** 1 | **Comments:** 3
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/let%E2%80%99s-talk-invoice-follow-ups%E2%80%94email-or-text/1364

### Content

Hi, Home Service Community! I’m Susan, owner of The Wheelbarrow Gardener in Edmonton 🌸. Keeping up with invoicing is crucial, and Jobber has made it a breeze! But I’m curious: "When it comes to invoice follow-ups, do you prefer using Jobber’s email or text feature, and how often do you send reminders?" I’ve found emails work well for most of my clients, but I’m considering trying texts for quicker responses. I’d love to hear what’s worked best for your business! INVOICE FOLLOW-UPS INVOICING LANDSCAPING TIPS
...
email first and then both if no response to the email. If I have to send more than two reminders I start every other day sending both
...
In our request form we ask the lead what their preferred method of communication is (Phone/Email/Text) and we start with their preference when following up on invoices or quotes. We ultimately use all of those methods if they don't respond to the first two follow ups. This delay is not common for us, however, as we focus on recurring cleaning services and require a card on file. We have to follow up only if the card is declined for some reason.
...
We utilize the automation feature in Jobber which has been a huge help. We do an automation a week after the due date and then 14 days (payment is due upon invoice). We send to both email and texts. We have some clients who don't have a cell phone (older customers) and some who don't have an email (or don't want to provide, and can be older as well). So we use the automation to cover both our bases.

---

## 45. Using Client's ACH payment portal Vs Jobber Payments

**Author:** Kyle_Klevjer (Contributor 2)
**Posted:** 2025-03-27
**Views:** 72 | **Likes:** 3 | **Comments:** 6
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/using-clients-ach-payment-portal-vs-jobber-payments/2675

### Content

One of our monthly recurring commercial window cleaning clients wants to pay using their corporate ACH payment portal rather than with their card on file with us. We've been serving them for about 3 years, automatically collecting payment with Jobber payments, but now they want to switch to their corporate system. This will also require sign off every time we come from a manager. We offered to have them use our ACH payment system via Jobber, but they want every vendor on their system. I'll be honest, I don't it. It's a hassle and we lose all control over the payment process, and it'll slow our team down a little having to check in every time we come out. That said, it's a smaller job and doesn't make a huge impact on us. Have others run into a scenario this? If so, how did you handle it? Thanks!
...
If companies don't fit within our systems & processes, we don't make exceptions for them. Sticking to your company policies is paramount. Over time, it can start to spiral out of control when you're dealing with 365 days a year.
...
to ryaantuttle Thank you for your and advice, Ryaan.
...
We do have a select number of clients that simply cannot follow our payment policies due to their corporate policies. As long as payment terms are set in advance and agreed upon contractually you should be fine. We break process for example with deposits. Some government contracts can’t pay us the deposit. It’s fine with us but we agree in advance on the actual payment terms. Hope this helps!
...
to TheProcessCEO Thank you, that’s helpful!
...
I spoke with the property manager. They have a corporate policy that keeps them from keeping cards on file with vendors. Because this is a fun job that our technicians enjoy doing and even competing on, and because we hit our charge rate consistently I opted to work with them and their ACH payment process. Thanks everyone for your input. ~Kyle
...
to Kyle_Klevjer I love it! Nice work, Kyle. Glad to hear you were able to get this resolved and keep a great vendor.

---

## 46. Payment Method Selection Hassle

**Author:** jay024464 (Contributor 2)
**Posted:** 2025-03-27
**Views:** 39 | **Likes:** 2 | **Comments:** 3
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/payment-method-selection-hassle/2570

### Content

Am I the only one that gets annoyed by having to select the payment method for my client every time I create an invoice? Some of my client pay by credit card, others ach, some checks. Why can't I just set directly on a client how they wish to pay so it defaults to this every time for that client rather than having to select this every time which on occasions allows for mistakes. Having jobber is meant to make things more efficient. Adding one extra layer of hassle every time I invoice in rather inefficient.
...
Hey Jay, Thanks for the question! Although the preferred payment method cannot currently be saved on the client level, I recommend changing your Jobber Payment settings to accept both CC and ACH payments on the invoice and quote levels. This way, the client can choose between the two without specifying beforehand. If the client wishes to pay by check, they can contact you to arrange that payment. To change your Jobber Payment settings to allow both ACH and CC payments, check out this Help Center article here. Thank you, Ryan, for the suggestion!
...
If you enable all methods of payment you won’t have to select the payment method for them in advance. Hope this helps!
...
Jay, Have you thought about reverse engineering the issue and having ALL clients pay via one method? When we started the business in 2018 we decided to ONLY accept credit/debit cards to simplify the process for our team and customers at the same time. It's been a company policy from day one.

---

## 47. Stage/Progress Payments

**Author:** Sunpak_Sean (Contributor 2)
**Posted:** 2025-02-27
**Views:** 121 | **Likes:** 3 | **Comments:** 4
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/stageprogress-payments/2029

### Content

Sorry if this question has been asked, i couldn't see anything when searching. We are a Electrical and Solar contractor and I'm trying to find the best way to do stage or progress payment invoices on a job. For example on Solar project we to do a 10% deposit to cover admin, permitting etc. This is easy in jobber. After that we to do a 50% of project invoice after equipment is delivered to site then a final 40% invoice on completion. I don't see a great way to do this and and pull of the project total. Any advice would be greatly appreciated. Thanks Sean ELECTRICAL CONTRACTING INVOICING
...
Hi there, thank you for the question! Jobber has a Lab out now for Progress Invoicing, if you are interested in trying it out, please go to the gear icon in the top right of getjobber.com > Jobber Labs > “turn on” Progress Invoicing (Beta). From this page, you can submit feedback on how you find it directly to the team. Alternatively, a workaround our customers have been using is as follows: use the quote to collect the deposit/first payment convert to a job When you’re ready to take the next payment click more actions to generate an invoice (the deposit will automatically carry over) Add a negative line item to the invoice for the amount not yet due and this will leave the invoice with the payment owing amount Send to the customer and let them pay When the time for the next payment reopen the invoice and either adjust or remove the negative line item and collect the amount.
...
to krista Is this discontinued? I can’t find the lab.
...
Perfect. Thank you ill try the beta and report back.
...
We are testing out progress payments for this same scenario and it’s working AMAZING! I hope it’s working for you!
...
**Posted:** 2025-03-27
**Views:** 52 | **Likes:** 1 | **Comments:** 2
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/error-credited/2689

### Content

One of my customers is showing a credit, but this has to be an error. I looked at all invoices and I don’t see where she has ever over paid. Please help as she owes us $900 BANK PAYMENTS (ACH) INVOICING ONLINE PAYMENTS krista Hi Sylvia123 thank you for this question! It sounds there might be a step missing by recording payments. Payments can be recorded from the billing history box. Click New > Collect Payment to enter the details of a payment you've received for this client. Click Save once you've entered all the payment details. Once a payment has been saved, it will be applied to the client's account balance. To apply this payment to an outstanding invoice, click the payment from the billing history box to edit it. There will be a dropdown for Applied to where you can apply this payment to an invoice. Note: This is a record of a payment that you've already received. Cards cannot be charged from the billing history box. Our Success Team would be happy to help you out with this, please reach out to 1-888-721-1115 option 1 or support@getjobber.com
...
Hi Sylvia123 thank you for this question! It sounds there might be a step missing by recording payments. Payments can be recorded from the billing history box. Click New > Collect Payment to enter the details of a payment you've received for this client. Click Save once you've entered all the payment details. Once a payment has been saved, it will be applied to the client's account balance. To apply this payment to an outstanding invoice, click the payment from the billing history box to edit it. There will be a dropdown for Applied to where you can apply this payment to an invoice. Note: This is a record of a payment that you've already received. Cards cannot be charged from the billing history box. Our Success Team would be happy to help you out with this, please reach out to 1-888-721-1115 option 1 or support@getjobber.com
...
Yes, in fact, I had collected deposits on quotes and then invoiced separately so invoices were not connected to quotes so it was adding up to look credits support was able to walk me through it. They were very helpful.
...
Hey Gutterz! Thanks for the question. I'm sorry to hear that your clients have been having trouble paying invoices through the client hub. I recommend asking your clients to check and see if their web browser is up to date. They also want to check to see if their mobile device or computer is trying to autofill any card info that may be old or expired. We do not believe this is a widespread issue, but it seems odd to have happened twice in a row for you! If this continues, please contact our Success Team for help. You can call them at 888-721-1115 ext 1 or email support@getjobber.com. You can also start a live chat, go to the ? top right corner > chat with us. I hope this information helps!

---

## 50. Jobber Disputes/Chargebacks

**Author:** Danpg1 (Contributor 2)
**Posted:** 2025-02-27
**Views:** 37 | **Likes:** 1 | **Comments:** 2
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/jobber-disputeschargebacks/2330

### Content

I've been using Jobber for almost seven years, and during that time, I've had about 25 customer disputes—cases where customers challenged their payment. Unless we work something out with the customer and they close the dispute, we lose every time. We also run a Shopify store and use PayPal and Braintree, where our win rate for disputes is over 85%. But with Jobber, we've never won a single dispute. Many of our disputes involve tangible products, sometimes with UPS or FedEx proof of delivery. Other times, we have concrete evidence of work completed, including before-and-after photos and GPS proof of our team being on-site. Despite providing this evidence, we still lose every dispute. I'm not sure how Jobber relays the evidence we submit, but it's shocking that we never win, even with clear proof. We process thousands of transactions, so our dispute rate is low, but has anyone else had the same experience? Have you found any effective ways to handle Jobber disputes?
...
Hello, and thank you for the question. We are so sorry to hear that all of your past Jobber disputes have been lost. Once a dispute is filed, Jobber will alert you and allow you to counter the dispute and submit evidence. Jobber submits the evidence directly as it is to the cardholder's bank for review. Jobber does not alter the evidence in any way. We have an article on our Help Center that explains the dispute process, you can find that here. Since it sounds you are familiar with the chargeback process, you may also find this article from our Blueprint Community useful to you, as it highlights was to protect yourself from chargebacks in the future.
...
From what I can tell, there has to be an issue with how Jobber submits the evidence we provide. There's no way we should be losing some of these disputes with the amount of proof we have. We've never won a dispute unless the customer voluntarily withdraws it. I’d be curious to know—out of the last 1,000 disputes—what percentage have been won by Jobber users when the customer did not close the dispute themselves. Our latest dispute was submitted and lost within just three days. That’s unheard of—I’ve never seen a bank make a decision that fast. We submitted strong evidence proving the customer was wrong and that we provided tangible products. Comparing this to our experiences with Braintree, PayPal, and Shopify, where we win almost every dispute, it’s clear there’s a serious issue on Jobber’s end and we 100% lose when we dispute via Jobber.

---

## 51. Jobs and Invoicing

**Author:** TopMate1 (Contributor 2)
**Posted:** 2025-02-27
**Views:** 42 | **Likes:** 1 | **Comments:** 2
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/jobs-and-invoicing/2307

### Content

Under "Jobs," I list Labor and Expenses, but when I go to invoice, neither appears. I am a production consultant who travels for my clients and bills for reimbursable expenses. My Labor is tracked by the hours, but I am not able to convert hours into payments. Any help here would be greatly appreciated. Also, the reimbursable expenses are pass-through and nontaxable (to me). INVOICING krista Hi TopMate1 thank you for this question! Currently, the information around Labour and Expenses remains on the Job. However, if from the Job's page, you update the line items to reflect the labor and expenses that will carry over to the Invoice. At this time, it is not automated. We would love to hear more about how automating this feature would work better for your company. Please don't hesitate to reach out to our Success team at 1-888-721-1115 option 1 or support@getjobber.com We track all suggestions and feature requests from users and tag them with themes and categories they fit into. This cumulative feedback helps to guide how the product is built out.
...
Hi TopMate1 thank you for this question! Currently, the information around Labour and Expenses remains on the Job. However, if from the Job's page, you update the line items to reflect the labor and expenses that will carry over to the Invoice. At this time, it is not automated. We would love to hear more about how automating this feature would work better for your company. Please don't hesitate to reach out to our Success team at 1-888-721-1115 option 1 or support@getjobber.com We track all suggestions and feature requests from users and tag them with themes and categories they fit into. This cumulative feedback helps to guide how the product is built out.
...
Krista, Thank you for the quick response! I'm just getting into Jobber to see if it fits my operations. So far I'm impressed enough to continue.

---

## 52. purchase invoices automatically linked to jobs

**Author:** seanr356 (Contributor 2)
**Posted:** 2025-02-27
**Views:** 64 | **Likes:** 1 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/purchase-invoices-automatically-linked-to-jobs/2274

### Content

Hi there, Can anyone tell me is it possible to have my supplier email my purchase invoice for materials to jobber with my job number attached that is matching jobbers job number and it save in my job pictures. Seems a super way to keep track of job expenses of not already available ELECTRICAL CONTRACTING PLUMBING krista Hi seanr356 Jobber has Expense Tracking, where the date, photo, details, amount, who to reimburse, what Job, and accounting code can all be recorded and reported on. At this time, Jobber doesn't have a field for Purchase Orders but as you explore our expense options please let us know how we might be able to build that out, we are always interested to know more about what our customers are looking for, and always collecting data on what is getting asked for a lot, we'd love to hear from you 😊 When convenient please reach out to our Success team at 1-888-721-1115, option 1 or support@getjobber.com Here is our help article on Expense Tracking
...
## 53. Invoice and getting paid for two entities LLCs

**Author:** LetsDig2020 (Contributor 2)
**Posted:** 2025-02-27
**Views:** 93 | **Likes:** 1 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/invoice-and-getting-paid-for-two-entities-llcs/2182

### Content

We have two different LLCs, Nieman Farms & Repair and Nieman Excavating. We use Jobber for the time tracking for the guys and organizing the jobs. Is there a way I can set up an option to switch the company name when invoicing/and bank account for getting paid? Emily AUTOMATIC PAYMENTS BANK PAYMENTS (ACH) CONSTRUCTION INVOICING ONLINE PAYMENTS
...
Hi Emily, thanks for the question. Jobber is optimized for one company per account, but we have a few options for you here. When convenient, please reach out to our Success Team at 1-888-721-1115 option 1 or support@getjobber.com

---

## 54. Adding Company Address to Invoice

**Author:** markiecooks (Contributor 2)
**Posted:** 2025-02-27
**Views:** 73 | **Likes:** 1 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/adding-company-address-to-invoice/2169

### Content

We started with a property management company handling all of their make-ready cleans. One of their requirements is that our company address is on the invoice. I have looked and can't seem to find where to do this. We currently have our office number, email, and website on there, but I do not see how to add the address. CLEANING INVOICING jade Hello Markiecooks! If you are looking to add your company address to your invoices, you will first need to make sure that your company address is listed in Jobber. On the web version, go to the Gear Icon > Settings > Company Settings > Fill out the address field. Once this is filled, it will show as a default on all invoices. If you are looking to add more than one company address on your invoice, you can do this by using Custom Fields. To add a custom field, go to the Gear Icon > Settings > Custom Fields > Invoice Custom Fields > Add Field. Set the field name as "Address", field type as "text" and default value as your full address, then create custom field. If you need a hand with any of this, please reach out to our Success Team who are always happy to help!
...
Hello Markiecooks! If you are looking to add your company address to your invoices, you will first need to make sure that your company address is listed in Jobber. On the web version, go to the Gear Icon > Settings > Company Settings > Fill out the address field. Once this is filled, it will show as a default on all invoices. If you are looking to add more than one company address on your invoice, you can do this by using Custom Fields. To add a custom field, go to the Gear Icon > Settings > Custom Fields > Invoice Custom Fields > Add Field. Set the field name as "Address", field type as "text" and default value as your full address, then create custom field. If you need a hand with any of this, please reach out to our Success Team who are always happy to help!

---

## 55. Mixing services and products - package

**Author:** LukeE (Contributor 3)
**Posted:** 2025-02-27
**Views:** 111 | **Likes:** 2 | **Comments:** 3
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/mixing-services-and-products---package/2055

### Content

I have a TV mounting business and I offer packages that include a TV mount - taxable inventory item, and the labor to install the TV. I want it to be one item, but apply sales tax to a portion of the ticket so I can collect tax, but only on the mount. Any insights into how to do this? INSTALLATION SERVICES
...
I spoke to Jobber support and it looks there is no way. This should be a feature as many other payment systems allow this. It would simplify things quite a bit
...
Hi LukeE thank you for the question! We love the idea of having a complex pricing package displayed as one line item to the customer. At this time, Jobber doesn’t have the tool to build this out, but we would love to hear more about how it would work best for your company. Please reach out to our Success Team at 1-888-721-1115, option 1 or support@getjobber.com
...
Great question - I'm not sure you can but perhaps someone else has a solution??

---

## 56. Purchase Orders, have you found a way to do them in Jobber?

**Author:** equipitdental (Contributor 2)
**Posted:** 2025-02-27
**Views:** 719 | **Likes:** 1 | **Comments:** 8
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/purchase-orders-have-you-found-a-way-to-do-them-in-jobber/331

### Content

Has anyone come up with an inventive way to create purchase orders in Jobber? I want an official looking form to email to my vendors and want to leave it open until the goods arrive. I'm thinking about creating a quote with a custom field for PO Number. I would have to create my vendors as clients and the PO I send them would say quote on it but I haven't found a better way. I looked at other software that integrates (or imports exports part info) but they are either pricey or clunky! Any thoughts!? jade Hello Equipitdental! We agree with our fellow community members and suggest using a custom field for the PO number! You can set the custom field up on the client, quote, job, or invoice level. You can also make this field transferable, meaning the value will carry over from the original level to the next steps in the workflow. (i.e. quote > job > invoice). Custom fields are useful as they will show in your reports. For more information on how this works, check out this help center article.
...
Look into Jobber Forms, tons of customizations to build it around your business and it's needs. Jobber Forms
...
**Author:** equipitdental
**Posted:** 2025-02-27

to BadgerHauling I was going to create a custom field (https://secure.getjobber.com/custom_fields ) I could add to the Quote and put a PO Number in there.
...
Yes, we added a customer field to the main customer file. The PO number shows up on both invoices and reports.
...
to TNLM06 Nice. So you're creating an invoice instead of quote? Thx
...
have you figure the best way to make a PO because when i make a custom field it still showing up as a quote, or invoice and my supplier do not accept it it that
...
to GloriousAir Hi, I have not found a way to have a form say "Purchase Order" but I have been using a quote to create a purchase order. I created the vendor as a client and put Purchase Order in their name. I created a part number called purchase order with all my info and make it the first line of the order. All my vendors have accepted this so far. Good luck.
...
Hello Equipitdental! We agree with our fellow community members and suggest using a custom field for the PO number! You can set the custom field up on the client, quote, job, or invoice level. You can also make this field transferable, meaning the value will carry over from the original level to the next steps in the workflow. (i.e. quote > job > invoice). Custom fields are useful as they will show in your reports. For more information on how this works, check out this help center article.

---

## 57. CASH-BASED Companies: Handling "Bad Debt"

**Author:**  (Contributor 3)
**Posted:** 2025-02-27
**Views:** 259 | **Likes:** 4 | **Comments:** 6
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/cash-based-companies-handling-bad-debt/1885

### Content

JL I have a question for other companies set up with cash-based accounting, regarding how to handle old unpaid invoices. Since we cannot write off bad debt as accrual-based companies can, how do you process it? I want to clear these unpaid balances out of our Jobber & Quickbooks open invoice reports (since they are so old and were sent to collections), but I still want to be able to see if a previous customer did not pay his/her bill. If I use the "Bad Debt" line item (that I think was a default in Jobber) it shows up as an expense on our P&L, which is not correct. INVOICING
...
BUILDER 1 You have to enter a credit note that you code to Bad Debt and match to the invoice in QB. This will clear it off.
...
JL to judithvirag When you say "credit note" are you talking about a credit memo in Quickbooks or something in Jobber?
...
to bedellmgmt TAG the customer with something "bad customer", "blacklist", "no service", etc. With that you can filter out the bad apples when doing reports or integrations to other apps.
...
to JL JLthe folks at Jobber Support can walk you through the best way to do this

---

## 58. Payment Collections

**Author:** FredHodgeJr (Jobber Ambassador)
**Posted:** 2025-02-27
**Views:** 214 | **Likes:** 4 | **Comments:** 4
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/payment-collections/1869

### Content

What's your process for managing overdue invoices in Jobber without hurting client relationships? INVOICE FOLLOW-UPS
...
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/payment-reversal/1799

### Content

Can I delete or reverse a payment that was made in error? I posted a payment made twice and I need to reverse one...or can it be deleted? JanineChambers If it is just a manually posted payment it can be deleted. If you are syncing to QBO the payment will also need to be deleted there manually. If it was an actual payment taken on a credit card however Jobber payments it will have to be refunded by clicking on the original payment.
...
If it is just a manually posted payment it can be deleted. If you are syncing to QBO the payment will also need to be deleted there manually. If it was an actual payment taken on a credit card however Jobber payments it will have to be refunded by clicking on the original payment.
...
Hey Vicki, thanks for your question. Janine is correct! If the payment was made using an offline method (e.x., check, cash, or other), you can delete it by going to the Client Page > Billing History > Select Payment > Delete. If the payment was taken through Jobber Payments, you will need to refund the payment by going to the Client Page > Billing History > Select Payment > Issue a Refund. If the payment was taken by a third-party payment processor that is integrated with Jobber, please reach out to our Success Team for help! You can call us at 888-721-1115 ext 1 or start a live chat by going to the ? at the top right corner > chat with us!
...
**Posted:** 2025-02-27
**Views:** 262 | **Likes:** 3 | **Comments:** 9
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/invoicing-title/1714

### Content

Why does the company name not show up on the invoice when I bill someone? The invoice weirdly shows the contacts person’s name but not the company name. INVOICING
...
BUILDER 1 Amazing :) Have a great weekend!
...
BUILDER 1 Did you set it up under settings? Maybe something is not entered corretly?
...
You should be able to make those changes in "Branding". (Screenshot attached)
...
BUILDER 1 Maybe you need to play around with the PDF Style. Here is ours
...
to judithvirag Thanks. I need the customers company name to show. Mine is fine. I do work for customers who run multiple businesses but all the invoices only show the customers name instead of the business names.
...
BUILDER 1 Also maybe this option is not clicked - Show company name alongside logo?
...
BUILDER 1 Apologies I misunderstood. When you set up your new clients do you click the - use company name as a primary name? For us it shows the company name for the client when we click this.
...
to judithvirag Perfect. That option doesn’t show in mobile. But it is available if I log in on desktop mode. Thank you!
...
Hey Possums! I am thrilled the community was able to help you out on this one. If you have any more questions on PDF settings or invoicing, you can check out our Help Center here;or reach out to our Success Team. Thank you Judith and Ryaan for your helpful suggestions!

---

## 61. Jobber Payments w/ Accounting Tools

**Author:** BadgerHauling (Contributor 4)
**Posted:** 2025-02-27
**Views:** 320 | **Likes:** 4 | **Comments:** 7
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/jobber-payments-w-accounting-tools/483

### Content

Hello Community! I just enabled Jobber Payments hoping to centralize everything invoicing inside the tool however, I am stumped with the deposits. For example just using simple numbers. I invoice for $100 and my deposit is < fees. In QuickBooks, my deposit doesn’t match the total of the invoice paid. Before Jobber, I was using QuickBooks’ payment processing and I would charge the same $100 and get the deposit of $100 and have an expense fee deducted from my account. This allows you to match your deposits to invoices and keeps IMO your accounting clean. I cannot be the only one with this issue. Thoughts from the Community? INVOICING
...
JOBBER COMMUNITY TEAM Hiya! We have an article that might help: How Items Sync Between Jobber and QuickBooks Online. For your specific situation, I highly suggest reaching out to our Success Team as well as they're best equipped to explain how to resolve the issue in detail!
...
to julie I did and this has been solved. I replied to another post down below.
...
to andrewluxuryre Any help or feedback would be much appreciated. Best, Andrew
...
to andrewluxuryre I think your issue will be solved once Progress Invoicing is out of Beta. If you want to take part in, I’d recommend reaching out to support to see if it’s still open. I personally don’t have it enabled since I am not collecting deposits or plan to progress invoice. However, maybe in the future, I explore this.
...
to bedellmgmt After working with my Jobber CSM we figured my concern out. Jobber does sent the correct values but it’s only found in your expenses. This is just a little different than I am/was used to. The invoice is zero’d out and all is good. BIG thanks to the Jobber team!

---

## 62. Short Code for Client Hub?

**Author:** FreshV1bes (Contributor 2)
**Posted:** 2025-02-27
**Views:** 146 | **Likes:** 2 | **Comments:** 4
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/short-code-for-client-hub/1108

### Content

I'm building a subscription service "house cleaning lite" business using Jobber. Jobber isn't really built for this (but I think it should work on doing so, as subscription services are growing crazy!) I've found a way to skip the "Quote" part of the process - we have flat fees for our services, so this extra step was keeping people from completing the purchase process. So when I get a request, we turn it straight into a job. But I want their payment information updated in the Customer Hub before we go out, so that their card is automatically charged upon completion of the work. Ideally? Jobber would create an ability to capture payment info on the Request form, adding it to the Client Hub in that first step. If someone completed the form, they would be my customer. For now? I really can't understand why there isn't an "Insert Variable" shortcode for the Client Hub. I have to use the full code in my Job confirmation email, and it looks clunky and ugly. Support, can you fix this? Other folks, how do you handle this? Thanks for any help. CLEANING
...
Im in the same boat. As a handyman business, some services are flat rates and set amount of time, e.g garbage disposal install is $150 and 90 minute block on calendar. But, new clients have to submit a request first rather than inputting there payment details and booking online directly. Haven’t figured out a way around it.
...
We created a recurring revenue stream with over 90 paying customer utilizing Jobbers "Recurring Jobs". Jobber also has the ability to scale with multiple locations, so feel free to reach out if I can help in anyway. It's been HUGELY successful for us! FreshV1bes
...
to ryaantuttle ryaantuttle- totally - we're using the "Recurring Jobs" feature for our subscription service, which is great. But from a customer perspective, our form is ugly - I wish Jobber would create something prettier. I actually apologize on the form itself ["We know the form you are about to fill out isn't winning any beauty contests. :)"] https://freshenmyhome.com/book-a-cleaning-form/ And, as I mentioned, I wish we could capture credit card info on the first pass.
...
Create your own form in Jotform if you're looking to spiff it up a bit and use Zapier for the connections. Thats what we've used on our website since 2018. We've never used Jobber forms since its not robust enough. https://besthandymanboston.com/request-estimate/ FreshV1bes

---

## 63. Invoice notifications moved to automator

**Author:** DenverStormDoor (Contributor 2)
**Posted:** 2025-02-27
**Views:** 66 | **Likes:** 1 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/invoice-notifications-moved-to-automator/1444

### Content

I see that the invoice notifications were moved to the new automation module, however I am getting an error when trying to change the invoice reminder workflow. Is anyone else getting this error? INVOICING
...
JOBBER COMMUNITY TEAM Hey DenverStormDoor 👋 Our Success Team is best equipped to help out here and look directly into your account! You can reach out to them by phone or through the chat function in your account. Thank you. : )

---

## 64. Progress Payments - really only for one off jobs?

**Author:** NancyD1977 (Contributor 2)
**Posted:** 2025-02-27
**Views:** 36 | **Likes:** 1 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/progress-payments---really-only-for-one-off-jobs/1374

### Content

I was stoked to see this roll out in beta but it doesn't make sense it would not apply to recurring jobs as those would be the most likely to have multiple draws. Is that really the case or did I read it wrong?
...
**Posted:** 2025-02-27
**Views:** 255 | **Likes:** 4 | **Comments:** 4
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/collections/768

### Content

We have found a major piece missing from Jobber is a section for Collections. How do you handle collections? We have multiple jobs for one client and when calling on overdue invoices there isn't a section where the notes can be kept that relates to just collections--don't want to muddy the info available on specific jobs as the collection notes relate to multiple jobs. Love to hear your ideas or apps or anything to streamline within Jobber. INVOICE FOLLOW-UPS
...
Until Jobber addresses this issue specifically, using the internal notes section on each individual invoice has been my best resource and tool for tracking collection attempts. I to use a coding system for my notations. For example, "10/24/24 - LM, EMd & TXd Inv., EMd stmt. mm." The translation being on 10/24 I left a message, then emailed and texted the invoice and also emailed a statement to the client. I use LF as my code when late fees are added to the invoice. When I reach a client by phone, my note will say something "10/24/24 PC (phone call) - client said they would pay by the 1st." Being able to keep track of what a client has said (or what I have told them) has been incredibly useful. I prefer to keep the notes on the invoice instead the client's main page so that other staff members who are not involved in accounts receivable are not privy to this somewhat sensitive information.
...
It would be great if we could set up an automation to remind the clients to pay their bill. 90% of mine are on auto pay but the few that are not, need nudged quite a bit.

---

## 66. System: Check and cash Payments

**Author:** SET_Brandon (Contributor 3)
**Posted:** 2025-02-27
**Views:** 138 | **Likes:** 2 | **Comments:** 2
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/system-check-and-cash-payments/1232

### Content

Our team collects payments in the field, and this is leading to problems. I just pulled $3k in checks out of one of our guy's van. When they collect payments, they mark them as "PAID" so those jobs are off our board. Often our customers want a receipt as soon as they hand them the money. So what do we do here? We've tried implementing a policy of check/cash collection, but even then they misplace or forget they collected money. I wanted to remove the ability for them to make jobs as PAID but it's tied into the editing system. They need to be able to make changes on the fly. I have no idea why this isn't separated. We have over 100k coming in monthly and no office staff. How are you guys handling it?
...
We control the payments at the office. Allowing employees and/or subs to take payments causes way too many internal and external problems if you ask me. We ONLY have accepted credit/debit payments from inception, just for that reason. It’s also a lot easier to track payments and charge the customers card if they don't pay you. Thats clearly written and stated in our estimates, too.

---

## 67. Creating monthly payments

**Author:** ShooFLY (Contributor 2)
**Posted:** 2025-02-27
**Views:** 94 | **Likes:** 1 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/creating-monthly-payments/1112

### Content

We have offered to spread a seasonal package over 12 monthly payments. We don't seem to have financing options for Canadian customers. Only current workaround is to create a monthly job with automatic invoicing and payment. However this causes challenged during the season and additional admin work. Does anyone have a solution or an easier way to set this up?
...
Hello! Thanks for your post! You are correct. We do not have a financing integration in Canada at this time. We are more than happy to submit that feedback as I can see how many users would benefit from this! We suggest automatic payments as a workaround. If you are having issues implementing automatic payments or setting up a schedule, please contact our Success Team! We are happy to help.

---

## 68. Invoice reminders on Jobs I get paid cash

**Author:** Lucas (Contributor 2)
**Posted:** 2025-02-27
**Views:** 191 | **Likes:** 2 | **Comments:** 4
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/invoice-reminders-on-jobs-i-get-paid-cash/821

### Content

I've been using jobber for 2 years now and there is a problem that I have just been dealing with. 90% of my jobs I get paid in cash. And at the end of every month I have a 50-100 invoice reminders that I have to drag and unschedule once every month it takes me about 20 minutes. Is there an option that I am unaware of to remove invoice reminders? If there isn't an option can the developers create something that. I'm sure it would be very helpful for current users. INVOICING jade Hey Lucas! Thanks for the question, it’s awesome to hear you’ve been using Jobber for your business for the last 2 years! When creating the Job, if it is a One-Off Job, it will have a check box for “Remind me to invoice when I close the job” for Recurring Jobs, you will see a drop-down that says “When do you want to invoice?” please select “As needed - no reminders” For Jobs that are already created, click the “Edit” button. If you do not want to go back and edit the jobs, but just want to clear up the calendar, you can use filters to hide “Reminders” please note, this will hide any quote reminders if you have them! If you have any questions on this, or feedback for Jobber - please reach out to our Success Team! You can start a live chat by going to the ? at the top right corner > Chat With Us to start the chat! or give us a call 888-721-1115 ext 1.
...
Hey Lucas - There isn't any other way around this that I know of. But maybe it would help to think of it as just part of the job/work flow. Perceived "extra steps" are never fun, but if you are charging enough for each job then, for me, it is easier to make it just part of the project! I deal with this one too. Any one else have any ideas to share with me and Lucas??
...
In your settings I believe you can turn off invoice reminders.
...
Hey Lucas! Thanks for the question, it’s awesome to hear you’ve been using Jobber for your business for the last 2 years! When creating the Job, if it is a One-Off Job, it will have a check box for “Remind me to invoice when I close the job” for Recurring Jobs, you will see a drop-down that says “When do you want to invoice?” please select “As needed - no reminders” For Jobs that are already created, click the “Edit” button. If you do not want to go back and edit the jobs, but just want to clear up the calendar, you can use filters to hide “Reminders” please note, this will hide any quote reminders if you have them! If you have any questions on this, or feedback for Jobber - please reach out to our Success Team! You can start a live chat by going to the ? at the top right corner > Chat With Us to start the chat! or give us a call 888-721-1115 ext 1.

---

## 69. How to close a recall invoice

**Author:** DevanS (Contributor 2)
**Posted:** 2025-02-27
**Views:** 286 | **Likes:** 3 | **Comments:** 6
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/how-to-close-a-recall-invoice/855

### Content

We own a plumbing company. What is the proper workflow for a recall job? We want to document the recall but do not collect any money. PLUMBING
...
to TheProcessCEO Is there a way to create an invoice from this recall visit if parts are used that need to be billed?
...
JOBBER COMMUNITY TEAM Thank you for flagging this, Wes! Our team has looked into the issue in the hopes of resolving this for you. Our team needs to be proactive to ensure the safety and security of Jobber payments. A member of our team will reach out to you shortly.
...
to FredHodgeJr I have been working on getting in touch with someone who can provide answers but that is proving to be very difficult. I got a new card processor set up today through my bank. So at least I can keep trying to move forward while I am dealing with retrieving the funds that are being withheld.

---

## 71. Invoicing options

**Author:** brandymm (Contributor 3)
**Posted:** 2025-02-27
**Views:** 108 | **Likes:** 3 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/invoicing-options/831

### Content

I love two new features on Jobber invoices, the option for ACH payments at lower fees than cards and also I have the option to turn off the card and ACH payments, if I only want a check or cash on certain jobs! Thank you Jobber for continuing to hear us and add to our toolbox! BANK PAYMENTS (ACH) INSTANT PAYOUTS
...
Isn't so amazing to have all of these payment options at our fingertips?!!!!! Great post!

---

## 72. Collecting Deposits By Credit Card

**Author:** pelicancorey (Contributor 3)
**Posted:** 2025-02-27
**Views:** 127 | **Likes:** 2 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/collecting-deposits-by-credit-card/764

### Content

Is there a way to pay a deposit or partial payment by credit after generating the invoice on the consumer side? I am only seeing a way to collect a deposit or partial payment manually. ONLINE PAYMENTS
...
Update: I received this answer from chat. Currently, there isn't a way for clients to make partial payments on their own through our client hub. When clients access their invoice online, they only have the option to pay the full invoice balance. However, we do have a couple of options for handling deposits or partial payments: 1. We can collect a partial payment for you if you provide your card information or have it saved in your wallet. 2. For deposits, we can add them to the invoice before sending it to you. This way, the deposit amount will be reflected in the total due. If you need to make a partial payment, please contact us directly, and we'll be happy to process it for you.

---

## 73. Suspend a recurring job account for non-payment

**Author:** Derek1 (Contributor 3)
**Posted:** 2025-02-27
**Views:** 107 | **Likes:** 3 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/suspend-a-recurring-job-account-for-non-payment/755

### Content

I own a residential lawn and yard maintenance business. Recurring job visits is our bread and butter. Mowing is about half of our revenue. We require a credit card on file, and auto-pay after each visit. We use Jobber's payment feature for this. This works really well, and eliminates accounts receivable. Occasionally a customer's credit card does not process. At that point, we receive an email from "The Jobber Team". The heading is: Automatic payment for "John Customer" failed. That is helpful. I would to see the following in Jobber, with automated functions. The owner (me) could set parameters/thresholds for the activities. But I really want to automate this process! Instantly when card is declined: Customer automatically receives an email and text, letting them know that their card failed. The email and text include the invoice, payment link, and link to update their card. The email and text are re-sent every day until payment is received. The job is automatically suspended. In other words, the future visits are flagged or suspended in Jobber until the account is paid and a card is on file. A report that shows on the dashboard for all credit cards that were declined. LAWN CARE ONLINE PAYMENTS
...
JOBBER COMMUNITY TEAM Hi Derek, thanks for your post! These are great suggestions and I can see how your ideas can help automate your process more efficiently. I’ve forwarded your ideas to Success as they collect all feedback to share with our Product Team who consolidates customer ideas/feedback so we can have a pulse on what would help our customers the most overall. Curious to hear from other members to see if they have any out of the box ideas or workarounds!

---

## 74. RECURRING VS ONE OFF

**Author:** GPEBix (Contributor 2)
**Posted:** 2025-02-27
**Views:** 106 | **Likes:** 1 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/recurring-vs-one-off/646

### Content

How do you set up T&M jobs without set dates or invoicing terms? One off with running total seems to fit best all things considered but recurring allows for directly taking employees notes and time recording and batch creating invoices. This said there are some drawbacks I can't find workarounds for. Either method leaves me open for losing trips unless I create a seperate invoice for each visit ieb which I end up consolidating into one final invoice if you will. I'm not a dog walker and feel as if the work flow was created for this type of service industry leaving me without a pollished system designed for the work I am performing. Thanks in advance for any feedback
...
JOBBER COMMUNITY TEAM Hey GPEBix! What billing cycle would you want to be billing your clients? (e.g. on a monthly basis) Keeping a reoccuring job going with visit repeats set to as needed shoulddd work well for this situation. You can edit each individual visit with recurring and have that reflect in the invoice better than if it was a one off job.

---

## 75. Preferred Payment Method 💲

**Author:** julie (Jobber Community Team)
**Posted:** 2025-02-27
**Views:** 226 | **Likes:** 1 | **Comments:** 3
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/preferred-payment-method-%F0%9F%92%B2/522

### Content

JOBBER COMMUNITY TEAM What's your preferred way to get paid in Jobber? Is it the same method your clients prefer? AUTOMATIC PAYMENTS BANK PAYMENTS (ACH) INSTANT PAYOUTS INVOICE FOLLOW-UPS INVOICING MOBILE CARD READER ONLINE PAYMENTS TIPS
...
JOBBER COMMUNITY TEAM to ReneeScraper Wowee! Sounds you've found a great balance between convenience for you and your clients. Building the credit card fees into your pricing is a smart move—makes things smoother for everyone. Also a good reminder to everyone that passing along credit fees is legal in most states but not all! And it’s definitely nice when clients use credit cards for those points or miles! 📈
...
to julie A note on credit card fees: it is legal in every state to build it into your prices. Noone can punish you for including it in your costs/expenses as a general pricing feature when figuring your costs per job. Where it gets to be illegal is to straight up charge a fee for running a credit/debit card On top of the service/items being purchased. You can have a minimum charge (ex: convenience stores won't take a card for a purchase below $25) which is far as I know is legal in every state. Unless laws have changed in the recent past, this is what I found out when researching how to handle credit/debit fees. Context: We have been accepting electronic payments, in the field, for about 9 years.

---

## 76. Partial Credit Adds to Money Owed

**Author:** jpqbn (Contributor 2)
**Posted:** 2025-02-27
**Views:** 104 | **Likes:** 1 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/invoicing-getting-paid/partial-credit-adds-to-money-owed/559
...
JOBBER COMMUNITY TEAM Hey jpqbn! I thinkk you might be talking about partial refunds? If that's the case, to balance out your account I recommend adding a negative line item to the invoice involved. I also suggest reaching out to our Success Team if you haven't already. I’m curious what other members have to say about other potential workarounds.
