...
**Author:** AmarilloWood (Contributor 2)
**Posted:** 2026-04-26
**Views:** 29 | **Likes:** 0 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/marketing-tools/marketplace-integration/10564

### Content

Hi I'm Tom, I'm new here and am having difficulties with Facebook Market Place. I don't have an advertising budget yet. I'm too small and sales are not consistent or regular enough. My clients rave about products, build, quality and price. I've been posting and relying on word of mouth for sales. I can't figure out how to promote my products or make a business page. Am I barking up the wrong tree. I'm local in the East Valley. Should I be starting in a different direction?
...
What product or service are you offering? And are you currently using an active Jobber plan?

---

## 2. $20k in First Month – How to Push Margins from 20% to 30%?

**Author:** Brightworks888 (Contributor 2)
**Posted:** 2026-04-08
**Views:** 88 | **Likes:** 4 | **Comments:** 2
**URL:** https://community.getjobber.com/discussions/marketing-tools/20k-in-first-month-%E2%80%93-how-to-push-margins-from-20-to-30/9921

### Content

Hey everyone, I’m just about a month into running my home service business and wanted to share where I’m at + get some advice. We’re on track to finish around ~$20k in revenue in the first month. Current breakdown: Contractors: 62% Expenses (VA, tools, etc.): 18% Net profit: ~20% Overall, I’m happy with the start, but I know there’s room to improve margins. For those more experienced: Would you focus first on raising prices or reducing contractor costs? What contractor % do you aim for at scale? Any early changes that helped you break into the 25–30% range? Appreciate any insight—working on tightening systems and scaling the right way.
...
Strong start $20k in month one with 20% net is solid. I wouldn’t rush to cut contractor pay first that can hurt quality fast. Easiest win is raising prices slightly (5–10%) on new jobs and testing close rates. Most people underprice early. For margins: Aim contractors at 50–55% max as you scale Lock in repeat crews at fixed rates (not per job surprises) Bundle jobs in the same area to reduce wasted time/logistics Big unlock most miss: tight quoting + upsells (add-ons at booking). That alone can push you from 20% → 25%+ without touching costs. Cut waste after—but grow top line smarter first.
...
## 3. Making website content

**Author:** threerelectric (Contributor 2)
**Posted:** 2026-04-08
**Views:** 182 | **Likes:** 0 | **Comments:** 7
**URL:** https://community.getjobber.com/discussions/marketing-tools/making-website-content/9343

### Content

So I am trying to make the website that is offered and I can not figure out how to add stuff to the contact us section can someone tell me how to do that. I want to add our address and our contractor number Contact Us (360) 355-8001 threerelectric@yahoo.com Client Login
...
## 4. How can I accurately track revenue generated from Jobber marketing campaigns?
...
I enjoyed being my own boss, I don’t my boss sometimes but I can’t quit either
...
## 6. How can Jobber help me grow my business?
...
Hello, in the same boat here, would love some more details as well.

---

## 7. Google Reviews Not Syncing to Website

**Author:** YaakovLewin (Contributor 2)
**Posted:** 2026-01-08
**Views:** 155 | **Likes:** 0 | **Comments:** 3
**URL:** https://community.getjobber.com/discussions/marketing-tools/google-reviews-not-syncing-to-website/7890

### Content

Hi. I've set up my website using Jobber's website builder and connected it to my Google Business Profile to display customer reviews as testimonials. The issue: When I first published the site, it pulled in my Google reviews perfectly. However, as new reviews come in on my Google profile, they're not syncing to the website - it's still showing the same number of reviews from when I initially connected it. My questions: Is this a known limitation, or should the reviews sync automatically? If they don't auto-sync, is there a manual refresh button or process I'm missing? Has anyone else experienced this, and if so, how did you resolve it?
...
Hi Sarina​, Thank you for trying those steps and for following up. I completely understand how important accurate and up-to-date reviews are, especially in industries where social proof plays such a big role. Since the workaround is not pulling in updated reviews for you, I would recommend reaching out directly to our Success Team. They can take a closer look at your specific website and Google connection to see what is happening and confirm whether this is expected behavior or something that needs further investigation. Please reach out to our Success team at 1-888-721-1115 option 1 or support@getjobber.com

---

## 8. Customizing Jobber AI Receptionist for Better Conversations

**Author:** emaidsjchoboken (Contributor 2)
**Posted:** 2025-11-08
**Views:** 225 | **Likes:** 2 | **Comments:** 5
...
I love the idea of integrating Jobber AI
...
When making campaigns is there a way to build a campaign that spans multiple weeks and dates. As of now its just a bunch of emails which isn't bad. But if thats the case, it would be nice to have another column with the scheduled send date if applicable. and would be nice if we could name that particular email with the campaign name. right now im doing a push to capture returning customers. I have about 6-10 emails going out. But i have another which focuses on captureing christmas light customers into the mowing divsion. they are not the same emails and do have a different tone and focus. not a big deal but helps keep things organized.
...
Maybe im an idiot and i dont think a coder. BUT why cant i just open up the campain audience selection. it has all the names of the clients, address and tags last service dates etc. and i just click a filter. hey find everyone with this tag. i click select all. then go and search another tag and select all now both groups are in. i thought that was what i was doing, but selecting include this tag but thats not everyone i need so lets add this tag. nope it filtered the list down even more because not everyone has (nor should they have both of the tags i am needing) no i don't want to mass message 400 people. for this as i would to give a more customized message to this particular audience. or a way to exclude customser who do have a visit upcoming in x days. its great thats an option. i am going after customers who are not already on the list....I DONT want them getting bombarded by a bunch of emails as they are already getting specific ones for them
...
**Posted:** 2025-05-08
**Views:** 355 | **Likes:** 1 | **Comments:** 4
**URL:** https://community.getjobber.com/discussions/marketing-tools/reviews/512

### Content

I have started using the new Review feature on the invoices. We have already gotten a couple of reviews, and the ability to respond is great. The only issue is that we want to restrict who receives these invites. It seems this option should be at the customer level and not only at the invoice level. We want to limit our commercial and industrial customers from receiving these. Any suggestions?
...
## 12. Does Jobber's AI Receptionist distinguish spam calls from actual customers.

**Author:** Moss912 (Jobber Ambassador)
**Posted:** 2026-02-08
**Views:** 131 | **Likes:** 1 | **Comments:** 2
...
I’m currently using open phone it’s a Ai receptionist that’s integrated with jobber. I it but it picks up all the spam calls and that impacts the amount of actual calls from customers it can take. Does jobber Ai receptionist distinguish spam calls?
...
## 15. How To Prevent New Client Requests from Being Mixed Into My Campaign List in Jobber?
...
When I build and distribute a campaign all my clients that were on the email list become newly updated and the persons that just sent a Request yesterday are integrated in the new mix and jumbled and forgotten. Is there a way to send a campaign and maintain everyone's date and order?
...
## 17. Can I Use My Existing Domain with the Jobber Website Builder?

**Author:** Jhowe (Contributor 2)
**Posted:** 2025-10-08
**Views:** 196 | **Likes:** 0 | **Comments:** 1
...
Can I import the web address that we already use into jobber website builder? krista Hi Jhowe​ Yes absolutely. Thanks for the question. Our help article: Set Up a Custom Domain for Your Website can walk you through the steps. If you have any additional questions please don't hesitate to reach out to our Success team at 1-888-721-1115 option 1 or support@getjobber.com
...
## 18. How Do You Bulk Edit or Consolidate Lead Sources in Jobber?

**Author:** Jola (Contributor 2)
**Posted:** 2025-11-08
**Views:** 131 | **Likes:** 0 | **Comments:** 4
...
## 19. Are we using Jobber to the fullest extent?

**Author:** PestFreeCanada (Contributor 5)
**Posted:** 2025-12-08
**Views:** 77 | **Likes:** 0 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/marketing-tools/are-we-using-jobber-to-the-fullest-extent/7578

### Content

I often wonder if there are features in Jobber that I have no idea about. Are there things that I am missing that could help me in my day to day? I see the great community questions that everyone is asking across the board but it is a lot to go through. I had an idea that the community could come together on a Zoom or Teams call to show off what we are doing to stay productive. Maybe create a list of things that each of us are doing that can help others, things that may be hidden in Jobber?
...
## 20. Jobber AI Receptionist

**Author:** FredHodgeJr (Jobber Ambassador)
**Posted:** 2025-05-08
**Views:** 19 | **Likes:** 11 | **Comments:** 18
...
SO when creating a campain. I am struggling getting the audience correct. I use the tags and the filters...but it would be nice to have that sort and then select individuals or a select all if individuals dont matter. i dont want some of the emails going to certain people for various reasons. jade Hey Blueskies, thanks for the question. You can set up your campaigns to include multiple tags to narrow down the results. If there are certain clients you do not wish to send campaigns to, but they fit under the selected tag, you can "unsubscribe" them. For more information and tips on how to create the perfect campaign audience, check out this article.
...
I know this has been asked before in different formats. I am asking again to provide more data points. I have spent HOURS sending out updating text messages (as email campains tracked by both mail chimp and other CRMs i have used) its about 20% open rate and about a 95% open rate with text. I have talked with everyone of my customers (i have over 500 as of this point for context) only 5 have ever said they prefer email communications. That is my opportunity i present. Lets get the 95% user rate. I do use the emails as it is very useful BUT please add a way to click on more than one customer and send them a text individually. My last system i used I paid less than half that Jobber costs (and jobber has many features that are cool and can be useful but day to day.....) and this was there and worked pretty seemless. With the client hub if that was a feature it would then be perfect. SO if that can be put in the pipeline, that would be great.
...
## 23. Anyone Tried Jobber’s New Get Noticed Score Tool?

**Author:** ryaantuttle (Jobber Ambassador)
**Posted:** 2025-08-09
**Views:** 76 | **Likes:** 4 | **Comments:** 6
**URL:** https://community.getjobber.com/discussions/marketing-tools/anyone-tried-jobber%E2%80%99s-new-get-noticed-score-tool/5207

### Content

Hey Jobber community! Jobber just rolled out a new free tool called https://tools.getjobber.com/score/GetNoticed to help analyze your online performance in seconds. It helps you: Find your Google Business Profile See how your business shows up online Get a personalized action plan to improve your visibility All you need to enter is your company name, zip/postal code, and industry, and it gives you instant insights. Has anyone here used it yet? I’d love to know: Was it easy to use? Did you find the action plan helpful? Did anything surprise you about your online presence? Do you think it needs polishing? Drop your experiences or thoughts below! CONSTRUCTION GENERAL CONTRACCTING GET NOTICED HANDYMAN REVIEWS
...
I do not currently have a website or much of an online presence. I need some help with setting up a website. Any suggestions would be greatly appreciated.
...
to LauraWhalen lets get you set up - Marketing Suite will build one for you step by step if you need assistance , we are here to help
...
to LauraWhalen Jobber offers websites directly through their platform. If thats too much cost at the moment, I suggest waiting until you have the funds or can at least put together a landing page.
...
Just tried it today and gave great feedback on my blind spots I didn't even think of.
...
Hey great look! I enjoyed seeing my score and getting some data on how i can improve. Very easy to use! Great graphics and it looks nice

---

## 24. Google Reviews only for marketing suite

**Author:** PLUMR (Contributor 2)
**Posted:** 2025-06-09
**Views:** 44 | **Likes:** 3 | **Comments:** 2
**URL:** https://community.getjobber.com/discussions/marketing-tools/google-reviews-only-for-marketing-suite/3726

### Content

can we please have strictly google reviews from the marketing suite as a seperate option or have it included from the connect and up plans, for solo operators its hard to justify the cost in usd for a simple feature that should be included but not the full price of a month subscription jade Hello! Thank you for bringing this to the community. Jobber offers the Reviews Marketing Tool add-on as an individual add-on outside of the Suite. If you are interested in just the Review add-on, go to the Gear icon > Account and Billing > Manage add-ons, from there you should be able to select just the Reviews for $39 USD monthly, plus applicable taxes. If you have any questions on how to utilize or add on the feature, please contact our Success Team, 888-721-1115 ext 1 or start a live chat by going to ? top right corner > chat with us.
...
Hello! Thank you for bringing this to the community. Jobber offers the Reviews Marketing Tool add-on as an individual add-on outside of the Suite. If you are interested in just the Review add-on, go to the Gear icon > Account and Billing > Manage add-ons, from there you should be able to select just the Reviews for $39 USD monthly, plus applicable taxes. If you have any questions on how to utilize or add on the feature, please contact our Success Team, 888-721-1115 ext 1 or start a live chat by going to ? top right corner > chat with us.
...
As another company who has the marketing suite simply for the Google reviews feature, we completely agree with PLUMR​.

---

## 25. Let’s build a network

**Author:** Mdkpresident (Contributor 2)
**Posted:** 2025-06-27
**Views:** 43 | **Likes:** 1 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/marketing-tools/let%E2%80%99s-build-a-network/4256

### Content

Hello everyone! I’m looking to connect with fellow professionals in the construction industry. What challenges are you facing right now? I specialize in problem solving and would be happy to share my skills and insights. CONSTRUCTION DOOR SERVICES ELECTRICAL CONTRACTING FENCE SERVICES FLOORING HANDYMAN PLUMBING PROPERTY MAINTENANCE REMODELING ROOFING WIN JOBS
...
Salutations to the trades ........trying to find my footing in this online market I've always done everything in person any advice ....I'm in construction
...
**Posted:** 2025-05-27
**Views:** 299 | **Likes:** 6 | **Comments:** 3
**URL:** https://community.getjobber.com/discussions/marketing-tools/email-templates/3678

### Content

It would be hugely beneficial if Jobber had the ability to create different email templates that could be selected when sending, quotes, invoices and emailing clients. Sometimes depending on the quote we need a different opening email when sending and currently have to delete the template message and write or copy and paste a different one. Seems a basic function that our previous CRM had but would reduce admin massively and add huge benefit when sending communication to clients. We had around 3-4 template emails for quotes, invoices and generic and all we had to do on our previous CRM was select the template from a dropdown
...
Great idea! That would be doubly helpful if the ability to attach general documents to different templates was included. Thinking spec sheets, or different contracts depending on the service.
...
Hi there, thank you for this feedback. That sounds a great idea, we would love to know more about each templates use case, and how you would to see it in your workflow. Jobber is made by the voice of our customers and features that get asked for a lot are the ones considered for future iterations. When convenient please reach out to our Success team at 1-888-721-1115 option 1 or mailto:support@getjobber.com and we would be happy to pass it along to the team.
...
to krista Hi Krista, This isn't my original post but I second MrElectro's idea. To answer your question though, different email templates for quotes would be helpful to provide a bit more detail in the body of the email for a specific type of product or service. In my experience, I have found that I'v been able to build more trust and rapport with customers when I provide a bit more detail in the body of the email containing the quote, not just the details within the quote. I've thought a lot about this as I provide extremely detailed quotes, however, in the body of an email, it makes people feel they're actually being talked to by a vendor trying to assist them - not just a vendor trying to sell to them, if that makes any sense.

---

## 27. Matching Google Reviews to Clients

**Author:** LukeE (Contributor 2)
**Posted:** 2025-06-27
**Views:** 21 | **Likes:** 2 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/marketing-tools/matching-google-reviews-to-clients/4022

### Content

Does anyone know of a way to manually match a client to a review? Seems there is an automated feature, but that does not catch every review and I can't find a way to manually match the ones that aren't matched automatically. Seems a pretty basic feature, not sure why Jobber hasn't included this.
...
One question I have is why you have to tag each person as unsubscribe? Does the marketing campaign not automatically unsubscribe them from an eligible email list?
...
to Mckunz This is just a redundancy thing we do, and it gives us insight on how that customer prefers to communicate. When we are in the mode to call past clients we can pull up that list of unsubscribed to call first.
...
How do you send emails to clients from 4 years ago?? The campaign automations in Jobber only allow for emails to customers from up to 12 months ago. This is a big problem for us because we have clients from years ago that only book every couple of years for duct cleaning or pressure washing. We currently have to pay an additional fee for an outside company to run basic email and text campaigns that run for more than 1 year.
...
to Cloud9JC There should be a dropdown tab for choosing between days, months, and years when creating a one-off campaign.
...
Is there a way to pick and choose which clients receive the emails? I only see the drop box qith a few options. I would to edit the list that comes out. Thanks
...
Great workCalebR !! Sounds you’re well on your way of taking advantage of the marketing suite. I highly suggest setting up the referral system for customers and affiliates too.
...
to ryaantuttle Will do! That's on the next admin meeting agenda for sure.
...
to CalebR Have you implemented a referral system? I’m looking into the best approach and would appreciate any insights you might have. We're considering either a fixed price or a percentage-based reward. We run a tree care business, and since our service values can be quite high, we want to ensure we’re maximizing the value of this initiative. We’re open to offering a 5% referral incentive, particularly for referrals from our existing customers, but I’d love to know how you’ve structured your program and what works best for you. Thanks in advance for your help!
...
to Roger We offer $50.00 off the customers next project and $50.00 for friends & family, too. We utilize Jotform and connect it to Jobber via Zapier in order to create a unique referral code which we use to track everything.
...
to ryaantuttle Thank you! I noticed that Jobber offers a tracker option. Is there another reason you prefer using Jotform? Thanks!

---

## 29. Automated Campaigns in HVAC

**Author:** CrystalW (Contributor 2)
**Posted:** 2025-02-27
**Views:** 156 | **Likes:** 3 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/marketing-tools/automated-campaigns-in-hvac/1924

### Content

We'd to start using the automated campaign feature to contact our clients when they're due for servicing, and I'm wondering if anyone has done this with their HVAC business so far and has some tips on how to set it up. Tags seem to be the best way to sort clients in Jobber but how do you tag or sort clients so the right clients are getting the right reminder at the right time? Thanks in advance! CAMPAIGNS HVAC
...
Hi CrystalW, that is a great question! It ultimately comes down to what works best for your business. Some of our customers to break out their client list by when they joined, “fall 2019.” Some use tags to mark what quadrant of the city a customer is. Some Jobber Clients will use specific services with either line items or tags to organize their client lists. What kinds of Campaigns are you going to create?

---

## 30. How to use jobber marketing and send to emails not saved or leads

**Author:** RSCcass0905 (Contributor 2)
**Posted:** 2025-02-27
**Views:** 154 | **Likes:** 2 | **Comments:** 2
**URL:** https://community.getjobber.com/discussions/marketing-tools/how-to-use-jobber-marketing-and-send-to-emails-not-saved-or-leads/1838

### Content

I am new to marketing and trying to reach out to local real estate companies all over the county and don't have them as current clients. I do have a few as leads from previous jobs but not sure how to send externally. Any ideas and help would be great. Thanks CAMPAIGNS
...
Hello there, thanks for the question! Jobber's Email Campaigns Marketing tool is designed for existing clients. I suggest creating a CSV file with any current leads and importing them to Jobber with a "lead" tag. Here is a Help Center article explaining how to set this up. Once the clients are imported, you can send out a campaign to any clients with a "lead" tag. If you need any assistance with this, please contact our Success Team at 888-721-1115 ext 1.
...
Tools LinkedIn, local business directories, and real estate listing platforms such as Realtor.com, Zillow, or Redfin are great for finding agent names and contact details associated with active listings. Many of these agents use their profiles to showcase their services and include contact information. Additionally, check for local rankings of top-producing real estate agents. These lists often categorize agents by performance levels (e.g., Bronze, Silver, Gold, Platinum) and can provide insight into who’s most active in your area. Don’t overlook your local real estate board or association websites ( the National Association of Realtors or similar state-specific organizations). These typically offer member directories, which can be a goldmine of information. Lastly, social media platforms Facebook and Instagram are highly effective. Many real estate agents and companies actively market their services there and often list their contact information in profiles or posts. Combining these tools should provide a strong foundation for reaching out. Once you have this information Jobber Marketing emails are great to send to them!

---

## 31. Tips & tricks for increasing open-rates and click-rates?

**Author:** julie (Contributor 2)
**Posted:** 2025-02-27
**Views:** 329 | **Likes:** 4 | **Comments:** 6
**URL:** https://community.getjobber.com/discussions/marketing-tools/tips--tricks-for-increasing-open-rates-and-click-rates/523

### Content

JOBBER COMMUNITY TEAM Do you have any advice for boosting your review campaign open-rate and click-rate? CAMPAIGNS REVIEWS
...
Its all about timing and content in my experience. I try to write emails and subject lines that speak to the person reading it. Is it helpful? Is it timely? Is it relevant to that reader? Too many businesses abuse their access to a persons inbox or text messages and it is making customers harder and harder to communicate with. I try to respect the access I have been given and in turn my open rates are typically pretty good. For Seasonal Services The highest open rates are seasonal booking reminders, seasonal cut off dates for booking, pre-season discounts, emails regarding how to request work online to receive priority service during the busy season All Businesses Periodic check ins, introduction to client hub, service reminders, thank yous, and new product launches Content -Short and to the point messages about things that matter to the person I am sending it to. -If a graphic is added to the email, using alt text in case it doesn't load and having any important information from the image listed elsewhere in text with a clickable link. Timing and Frequency I treat email marketing as a slow burn form of marketing I don't expect every email to be a hot seller I want the emails to plant a seed of who to call, how to book, why to book, and when to book. I try to establish trends and reach out to customers before they reach out to book. Internally it keeps the phone from exploding on a single day and customers find it convenient because it is one less thing to worry about.
...
Yes!! Split-test everything you send out.
...
I just watched this video: "Jobber video new revenue from old customers" from the jobber podcast yesterday, it has a few great strategies on how you can boost open and click rates and what is considered a good % for those too, which I found very valuable. Frequency and call to action were big takeaways.
...
## 32. Referral Program/Auto Payments

**Author:** EnovanaRaleigh (Contributor 2)
**Posted:** 2025-02-27
**Views:** 250 | **Likes:** 3 | **Comments:** 4
**URL:** https://community.getjobber.com/discussions/marketing-tools/referral-programauto-payments/1132

### Content

We the Referral Program but have one major issue: credits aren’t automatically applied to recurring clients. We have to apply them manually each time. We've given feedback to Jobber and hope they address this. If anyone else has noticed this, please reach out to Jobber; the more voices, the better chance of a solution. LEAD GEN
...
I would think that just having the credit apply towards the clients overall account would be best. I have some that will start accuring credits but will want to spread them out over their repeat services. Just a thought.
...
Hey Enovana! Thanks for the question. The Referral Marketing Add-on is intended to automatically apply a credit to the client’s next invoice. If you are hoping for the referral credit to be applied to all recurring invoices, we don’t currently have a feature that, but I will certainly submit this feedback to our Product Team!
...
to jade Jade, I manually marked a few Referrals and associated the referring client. Is the expected behavior only to see the credit when client A sends the referral link to client B?

---

## 33. Just did our first campaign!

**Author:** JonahAlcalde (Contributor 2)
**Posted:** 2025-02-27
**Views:** 106 | **Likes:** 2 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/marketing-tools/just-did-our-first-campaign/1420

### Content

We just ran our first campaign with jobber and we loved it! I'm curious to know how many of you are capitalizing on this great feature! I love Jobber for how well integrated everything is. Its amazing to have everything all in one place! CAMPAIGNS
...
JOBBER COMMUNITY TEAM Woohoo! That's so great to hear. What were the most significant differences you've noticed with and without Jobber's marketing campaign?

---

## 34. What do people think of the Jobber Websites?

**Author:** Hourpeople (Contributor 2)
**Posted:** 2025-02-27
**Views:** 299 | **Likes:** 3 | **Comments:** 4
**URL:** https://community.getjobber.com/discussions/marketing-tools/what-do-people-think-of-the-jobber-websites/713

### Content

My website is 15 years old & needs an update, I rank #2 in my area currently but still wouldnt say it generates much work. Most of our work is gov contracts & other work comes through word of mouth. Would you use the Jobber website, I use Jobber for everything else.
...
We use the jobber landing page website and works great! I also use a company to help us with SEO and they have gotten us great results.
...
Whats your domain? Would love to take a look to give the best advice. A website without SEO, even when you believe your ranking well is almost a nice car thats trapped in a garage.
...
to FredHodgeJr I'd that. The Best Plumbers In Pensacola, Florida! Any help is appreciated!
...
I created my own website and use it for all advertising, email etc. I did activate the Jobber website as it will appear in a google search for you name. So I encourage you to use every site available to promote your company. Next door, Yelp, Thumbtack if you register will also put you your name on top. But I do not advertise with any of them. If you want to know more feel free to contact me at 720-850-8376 or email jt@homeproecg.com

---

## 35. Referral Feature - Choosing incentive structure

**Author:** seanroz (Contributor 2)
**Posted:** 2025-02-27
**Views:** 628 | **Likes:** 6 | **Comments:** 9
**URL:** https://community.getjobber.com/discussions/marketing-tools/referral-feature---choosing-incentive-structure/326

### Content

What incentive option are you all finding works best; percentage-based vs. set dollar amount? I'm curious about what others are doing to spread the word about this new referral system to existing clients and prospective clients (aside from the email campaigns within Jobber) EMAIL MARKETING JUNK REMOVAL LANDSCAPING LEAD GEN
...
Haven't tried out the feature yet, but was curious about it since it's a thing that I was thinking about implementing. In my line of business (Stairs and Railings) where there are no return visits and all jobs are one and done, I don't think that a lot of people would use this feature. If i change my mind about it I would probably offer $100 for a referral and do more for the jobs that are bigger. Let's be honest $10-$50 is not that much for a stair job that will land you a $2500.
...
JOBBER COMMUNITY TEAM to Art Hey Art, I can understand your perspective. Referrals in a one-and-done business stairs and railings might be trickier to incentivize. Offering $100 per referral sounds a good start! Have you considered any other ways to encourage referrals? Maybe rewarding the referrer with a discount on future services or gift cards?
...
So I think it depends on yours jobs and how much your average job is. We decided to go with $10 off for every referral because that is smarted for us, and keeps more profit in the business. We think that this is a good concrete choice that our clients will understand and see the value in as well. We just started it as well, so I am not sure, but i imagine our B2B ‘s are going to be taking advantage of this the most- they know they are going to have jobs in the future that this will be applied to and would be helpful for. For spreading the word, we are going to use the Campaign feature. I wasn’t sure at first because I thought that there wasn’t a good way to make sure we are only sending this out to the people that we want to offer this to. But we found a way to do it. We are going to tag our clients that we don’t want to do that referral program with “no referral program” (i know, original). And then when you go to send out the campaign, you can say everyone except a certain tag.
...
to NewCreationsSea I the method of sending to tagged clients. We recently found out that in the client hub, the "refer a friend" button displays their referral link. Aside from this and campaigns, I don't see another way to retrieve links for specific clients. Here is a sample post I put together for social media; to market the referral feature
...
JOBBER COMMUNITY TEAM to BadgerHauling I agree! Thanks for sharing a visual example of your referral program seanroz
