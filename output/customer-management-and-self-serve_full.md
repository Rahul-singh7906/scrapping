...
I don't really see this as an issue if your business is setup correctly... No single person should have control over money, that's pretty much standard process. For example large businesses who need to pay big invoices, payroll, etc. will require multiple authorisations before a payment is processed. Same principle if a sales guy is accepting payments - it shouldn't happen! They handle the sales, your office/AP handles the money. It's something every business should absolutely be aware of, and as your business grows you need to continually keep track of the access level available to staff, and make sure there's a degree of separation. Basically it's not a software issue, it's an organisational structure and process issue. Having said that, yes an audit log would be nice.
...
Hi PestFreeCanada​ and Conrad​ Great question, and thanks for sharing that example, definitely a tough situation and a good reminder of why visibility and controls matter. In Jobber, there is an Activity Feed that shows the most recent actions taken within the account (up to the last 100 actions), based on your notification and activity preferences. This can help provide visibility into who is making updates and when. In certain cases, additional information may be retrievable with support from our team, though this is typically limited to more serious situations and may require further review. You can also manage team permissions and roles to limit access to sensitive actions, which can help reduce risk as your team grows. If you’re looking for something more specific in terms of tracking or controls, I’d love to hear more about your use case and can share that with our Product team!

---

## 2. Client email responses and communication histories

**Author:** martalucia (Contributor 2)
**Posted:** 2025-09-08
**Views:** 137 | **Likes:** 0 | **Comments:** 2
...
## 4. Needed Feature: Add Before & After Photos for Individual Visits
...
## 6. How to prevent or merge duplicate client records when syncing with QuickBooks?

**Author:** HotTubDave (Contributor 3)
**Posted:** 2025-05-08
**Views:** 491 | **Likes:** 3 | **Comments:** 12
...
## 7. 💡FEATURE REQUEST: Schedule Send Communications
...
## 8. Question for Jobber Team: Why Are Filter and Sort Settings Not Persisted?

**Author:** tbarth (Contributor 3)
**Posted:** 2026-02-08
**Views:** 172 | **Likes:** 1 | **Comments:** 4
...
## 9. Why is Property Name missing in add/edit property? (It's visible in client edit view.)
...
## 10. How does Jobber’s texting system handle multiple contacts for one client? Texting System is Lacking

**Author:** dcholding302 (Contributor 3)
**Posted:** 2026-03-08
**Views:** 102 | **Likes:** 1 | **Comments:** 1
...
It is very hard to know who we are talking to as many of our clients have multiple points of contact (husband/wife), maybe the GC on the project. But our commercial clients can have 2-5 contacts easily, the company plus managers. The text system currently displays the Client or Business Name and the phone number.... but the phone number is often cut-off completely. And there is Zero way for us to see who we are talking too as you can not click into more details per text. What we need at minimum right away - A way to see the full phone number of the texter What we would to see very soon - The name of the person texting if they are in a client file... if a number can be matched to a file, then you can match it deeper to the actual contact name. What we need ultimately - we need to be able to choose who we text quicker and easier. From the desktop browser we pull up a client file, and under Contacts it lists multiple people, currently you have to copy and paste that phone number into the text box. We need a Text this person option/button by there name/number. That opens a the text chain in the text pane, showing all past conversations with the specific person. The absolutely ideal scenario - all of the above and Contacts Management (and let us link it to our google, apple, whatever contacts) this rolodex of contacts will allow the system to reference it for the name correctly when a random texts us that we know. (ie. If Joe Contractor texts me about a job, but he is not listed anywhere in Jobber, I need to be able to save his number as a general contact, so his name shows up instead of just a number).
...
## 11. Referral Credit System Is Very Lacking
...
to HUGEHomePros yup, this has been emailed to support also.
...
## 12. Custom fields missing when editing existing properties

**Author:** Kevin_G (Contributor 2)
**Posted:** 2026-02-08
**Views:** 67 | **Likes:** 0 | **Comments:** 1
...
**Author:** Naz (Contributor 3)
**Posted:** 2025-05-08
**Views:** 558 | **Likes:** 9 | **Comments:** 9
**URL:** https://community.getjobber.com/discussions/customer-management-and-self-serve/duplicates-merge/1141

### Content

Hi guys. Its been a while we been asking for a possibility to merge contacts. Simple as any other crm has. Hope to get more likes on this post and it will be implemented soon. Thanks Naz (Using jobber since 215)
...
## 14. How to manage duplicate clients, flags, and scheduling visibility in Jobber?

**Author:** CookAppliance (Contributor 2)
**Posted:** 2026-02-08
**Views:** 171 | **Likes:** 1 | **Comments:** 1
...
Hello, A few things I'd love to see added to jobber, if not already there and I have the wrong package. Being able to merge clients! When multiple people answer the phone, some do not check for previously entered spelling errors and such, we end up with multiple duplicate clients. Multiple jobs/invoices are scattered within all the duplicate clients. Being able to flag clients, maybe a color coded flag red for no service at all, yellow, needs payment collected first or allow us to label our flags how we need to. Or give us a drop down box to make selections by color, or a preview box so we see it as soon as the clients name is entered before scheduling and without it being on the profile for invoices and receipts. Color highlight for clients that are on the schedule, if someone is flexible and can be worked in on a day we have a cancelation or a color if they have to have a solid appointment day. These colors need to be separated from the team colors and be able to be seen on the calendar view so CSR's can see at a glance that someone can be worked in right away if there is a cancelation. That's all I got for now :)
...
## 15. Subjecting potential customers to marketing emails and promotions??!!
...
Is there anyway way to disable this on the request form? I guess I'm happy it tells me that Jobber would be selling my customers information, but it doesn't look good for my business when I'm basically telling a potential customer that yup, reaching out to me for help is going to give you spam emails.
...
## 18. International Customers - Getting Ripped Off
...
## 19. 2 WAY SYNCING WITH QUICKBOOKS NOT WORKING

**Author:** JonathanP (Contributor 2)
**Posted:** 2025-05-08
**Views:** 118 | **Likes:** 1 | **Comments:** 2
...
**Posted:** 2025-07-08
**Views:** 111 | **Likes:** 1 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/customer-management-and-self-serve/client-communication-preference/4139

### Content

Is there an option for clients to choose their preferred communication method? krista Hi deanham_ec​ Great question! If you setup your Request Form to ask for their preferred method of contact you would be able to use Custom Fields or Notes to keep track of the preference. This help article can help you with setting up the Request Form. Thanks for the question!
...
## 21. Workaround: click-to-call from ANY phone field in Jobber (works with Quo, OpenPhone)
...
## 22. Need custom field ideas?

**Author:** rebecca (Jobber Community Team)
**Posted:** 2025-02-27
**Views:** 118 | **Likes:** 1 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/customer-management-and-self-serve/need-custom-field-ideas/552

### Content

JOBBER COMMUNITY TEAM What custom fields or tags have you added to your client profiles to track what’s important to you? CLIENT MANAGER
...
We have left a Google Review." However, I wish we did not have to rewrite the tag each time. It would be great to generate a list that we can use.

---

## 23. Work around for client imports failing?

**Author:** Jacob_Thifault (Contributor 2)
**Posted:** 2025-03-27
**Views:** 26 | **Likes:** 2 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/customer-management-and-self-serve/work-around-for-client-imports-failing/2753

### Content

I am uploading about 1.7k clients to jobber for integration, but keep getting the "job failed within 6 seconds of starting" error message. My .csv file is clean, no errors, and jobber internally says all 1.7k are valid and have no errors. Anyone know how to work around this? TIA! jade Hey Jacob! Thanks for the question. The reason you're having trouble is that the client import will only support 1500 fields at once. I recommend cutting the CSV file into two sheets and then trying the upload in two parts! If you are still running into issues, give our Success Team a call 888-721-1115 ext 1.
...
Hey Jacob! Thanks for the question. The reason you're having trouble is that the client import will only support 1500 fields at once. I recommend cutting the CSV file into two sheets and then trying the upload in two parts! If you are still running into issues, give our Success Team a call 888-721-1115 ext 1.
...
**URL:** https://community.getjobber.com/discussions/customer-management-and-self-serve/text-messages/2694

### Content

Is it possible to have text messages marked as unread even if another member of our team has opened them? I would to log in with my own credentials and still see all the messages that I haven't personally opened yet. Is this possible in Jobber? TWO-WAY TEXT MESSAGING krista Hi Meloni thank you for the question! If there is a message that you would to come back to later, it can be marked as unread in the message center so that it still appears as a new message. To mark a message as unread, in the top right of the message, click the More actions icon (...) > Mark as unread. Both the new message flag and red dot on conversations indicate that a message has been read. These indicators operate on the account level which means that if a user opens a new message, that message will appear as read to all users on the account. We would love to hear more about how this system could be improved for your company. Please reach out to our Success team at 1-888-721-1115 option 1 or support@getjobber.com
...
Hi Meloni thank you for the question! If there is a message that you would to come back to later, it can be marked as unread in the message center so that it still appears as a new message. To mark a message as unread, in the top right of the message, click the More actions icon (...) > Mark as unread. Both the new message flag and red dot on conversations indicate that a message has been read. These indicators operate on the account level which means that if a user opens a new message, that message will appear as read to all users on the account. We would love to hear more about how this system could be improved for your company. Please reach out to our Success team at 1-888-721-1115 option 1 or support@getjobber.com

---

## 25. 📧Email & 💬Text Templates (Not just for Quotes and Invoices)

**Author:** Jessica-2025 (Contributor 3)
**Posted:** 2025-03-27
**Views:** 76 | **Likes:** 5 | **Comments:** 3
**URL:** https://community.getjobber.com/discussions/customer-management-and-self-serve/%F0%9F%93%A7email--%F0%9F%92%ACtext-templates-not-just-for-quotes-and-invoices/2516

### Content

We send repetitive texts and or emails to customers. We would ❤️Love it if Jobber offered text and email templates for any message. Maybe we could also use these templates/canned messages when responding to messages. These messages range from reminders regarding payment to "what to expect" or "what we need from you" regarding their upcoming project. It would be 💥 fantastic if we could click on a template, edit it as needed, and then send off the message! The quote templates have been amazing to use; we hope this soon follows... Thank you for considering our requests ☺️ ==> If you would benefit from this feature PLEASE 🙏 Click that 👍" " Button <== CLIENT HUB CLIENT MANAGER INTEGRATIONS TEXT & EMAIL TEMPLATES TWO-WAY TEXT MESSAGING
...
We think this is a fantastic idea, as well! I've played around with an email in the Automations area that rewrites the invoice follow-up emails and texts for after a visit, but there doesn't seem to be a good way to see the reporting or success of the "campaign". Also, the only 2 triggers there are Quotes and Invoices so neither really works for a booking that doesn't need a quote. We would to see the Marketing area improve so we could use templates the way Jessica explains.... Very helpful!

---

## 26. ARE YOU ABLE TO TRAIN THE AI RECEPTIONIST TO ANSWER MORE QUESTIONS FROM THE CUSTOMER?

**Author:** MICHAELG (Contributor 2)
**Posted:** 2025-03-27
**Views:** 82 | **Likes:** 2 | **Comments:** 4
**URL:** https://community.getjobber.com/discussions/customer-management-and-self-serve/are-you-able-to-train-the-ai-receptionist-to-answer-more-questions-from-the-cust/2557

### Content

ARE YOU ABLE TO TRAIN THE AI RECEPTIONIST TO ANSWER MORE QUESTIONS FROM THE CUSTOMER? AND IF SO, HOW? RIGHT NOW IVE BEEN PRACTICING WITH THE FREE AI RECEPTIONIST AND I WOULD NEED IT TO DO MORE THAN IT ALREADY IS
...
Im using it now for the last week and so far its hit and miss, works great for basic call taking but cannot deal with emails or address of customer and caused a lot of them to hang up or get angry due to the issues with taking information
...
to MrElectro Finding the same outcomes 🤬. And it only assigns tasks to Admin-level users. We should be able to pick the person within our account to whom the task gets assigned. I don't know about others, but my receptionist (human) doesn't have admin privileges for ANY software we use in our business.
...
Great question. We are following this thread; we are considering signing up for AI Receptionist.
...
Hello Michael G! Thanks for the question; Jobber does not currently have a way to train the AI Receptionist. However, we will continue to develop and improve this feature. Your feedback is very important. To share your feedback directly with our Product Team, please fill out the feedback form on the Manage tab on the AI Receptionist dashboard.

---

## 27. Who has Jobber dialed in using Automation

**Author:** greed007 (Contributor 2)
**Posted:** 2025-02-27
**Views:** 550 | **Likes:** 5 | **Comments:** 5
**URL:** https://community.getjobber.com/discussions/customer-management-and-self-serve/who-has-jobber-dialed-in-using-automation/2096

### Content

I don't think I am utilizing all Jobber features and would to learn more on how to do that, it would be great to find another contractor who has their Jobber really dialed in and utilizing all their features with Automation and even the integration's as well. Love to connect with any Contractor that has theirs set up and showing great results. Please feel free to reach out, gary@moreheatmorecool.com or 937-794-5060, I would be open to paying someone to help me set mine up as well. Thanks, Gary
...
Gary that's a great question you asked! I know WiringByron has some really great automations set up and would be a great person to reach out to.
...
to ryaantuttle Thanks for the shout out! I'll reach out. Cheers.
...
to WiringByron Awesome! Looking forward to chatting, 937-794-5060, gary@moreheatmorecool.com Thanks

#### Reply 4

**Author:** MORGANLAWN5912
**Posted:** 2025-02-27

Hey Byron have you figured out a way to reset schedule once automated if things get off schedule?
...
to MORGANLAWN5912 Could you explain that one a little more, it’s just not something I’ve come across. We also don’t have reoccurring visits in my company, everything is a one off job.

---

## 28. Who has a client maintenance plan set up?

**Author:** greed007 (Contributor 2)
**Posted:** 2025-02-27
**Views:** 158 | **Likes:** 1 | **Comments:** 2
**URL:** https://community.getjobber.com/discussions/customer-management-and-self-serve/who-has-a-client-maintenance-plan-set-up/2097

### Content

Who has a client maintenance plan that is set up in Jobber for annual or monthly reoccurring fees? Love to connect with someone in efforts to help me get mine set up. Thanks, Gary CLIENT MANAGER jade Hey Gary! Thank you for the question. We would recommend setting this up as a recurring job with automatic payments. In order to collect automatic payments, you will need to have the clients card saved on file. For more information on this, here is a help center document on automatic payments. If you plan on collecting payments at a different frequency than you do the maintenance visits, you may need to set up two recurring jobs for this.
...
Hey Gary! Thank you for the question. We would recommend setting this up as a recurring job with automatic payments. In order to collect automatic payments, you will need to have the clients card saved on file. For more information on this, here is a help center document on automatic payments. If you plan on collecting payments at a different frequency than you do the maintenance visits, you may need to set up two recurring jobs for this.
...
Its depends how you set it up.. Reoccurring vists with a monthly visit does not show the service date on the invoice versus recurring visits with a per visit price.

---

## 29. Two Way Texting with Multiple Technicians

**Author:** BenSimpson (Contributor 2)
**Posted:** 2025-02-27
**Views:** 135 | **Likes:** 1 | **Comments:** 3
**URL:** https://community.getjobber.com/discussions/customer-management-and-self-serve/two-way-texting-with-multiple-technicians/2056

### Content

Wondering who out there utilizes the two way texting feature for the bulk of their communication with clients and who has multiple technicians/office staff? I'm just getting my lawn service going in Jobber. We currently communicate a lot with customers via txts. We currently use a pretty awesome service that organizes messages well so that messages do not slip through the cracks. I fear if we tried to switch to Jobber for the bulk of our txt conversations, technicians will be annoyed getting notifications from conversations not relevant to them, and maybe even start ignoring notifications all together and miss responses/questions that are relevant. How does everyone manage the craziness of multiple conversations going on at the same time by different workers/clients? TWO-WAY TEXT MESSAGING
...
to bedellmgmt Captivated Texting. One phone number. Shared inbox. Incoming texts go into a general queue that only people with manager access see. They then assign the conversation to users. Once a user is done conversing with a customer they mark the conversation as complete so that the next time the customer texts in, it goes into a queue. It can be a little confusing for customers at first because they will communicate with multiple people from the same number. if our sales person is the first person they text with they may save the contact as "Joe- Lawn Care Guy" or something that. So all texts from them they think are from Joe. But for the most part customers have no problems and it way better than they getting txts from all kinds of different numbers.
...
Hi BenSimpson, thanks for this question! We would love to hear more about how the SMS application organized the messages to prevent irritation to everyone receiving them and how Jobber might improve our own! When convenient, please contact our Success Team at 1-888-721-1115, option 1, or support@getjobber.com. We would love to hear more!
...
I use them for maintenance or scheduling primarily but they can be used for identifying the type of client or service type. For example pools you installed vs pools you service. Year they started working with you. I don't rely too heavily on them because I always forget to update them when things change but they are great if you can set them and forget them.
...
We have been using them to quickly find commercial client references. For example if we did a successful community gutter cleaning. We tag it and then if a future bid asks for gutter cleaning references we have a list to provide. We love it!
...
JL We use "Call Back" and "Follow up [month]" tags to easily pull a list for follow up. We tag customers that need touch ups (we are a painting business). Also, if I temporarily turn off quote/invoice/etc. notifications while making an edit, I use a "Notifications OFF" tag to remind me to turn them back on.

---

## 31. Show more future Jobs in client portal

**Author:** Sanctuary (Contributor 2)
**Posted:** 2025-02-27
**Views:** 99 | **Likes:** 2 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/customer-management-and-self-serve/show-more-future-jobs-in-client-portal/1867

### Content

Hi. My clients who we have encouraged to use the client portal are messaging me saying they have more jobs booked in. Which they do. But the portal cuts off the listing of upcoming jobs part way through the day, 2 days in to the future. This wastes the time of our clients and us to confirm we do actually have the jobs booked in. Could the date range of the jobs shown in the portal be selectable by the client so they can be sure what they are seeing is accurate. Thanks so much. 😁 Kylie-Anne CLIENT HUB
...
Hey Kylie-Anne, thank you for bringing this to the community! In the client hub, clients can see a list of all their previous appointments and the next five of their upcoming appointments as long as those upcoming appointments are within 60 days of today. There is no way to turn this feature off completely, but you can change whether the client view shows the specific time and date or just the date, and this can be toggled in your settings by going to the Gear Icon > Settings > Client hub. If you believe that the client hub is showing more or less than what is listed above, please contact our Success Team so we can investigate! You can call us at 888-721-1115 ext 1, start a live chat by going to the ? at the top right corner > chat with us or email support@getjobber.com
...
**Posted:** 2025-02-27
**Views:** 144 | **Likes:** 1 | **Comments:** 2
**URL:** https://community.getjobber.com/discussions/customer-management-and-self-serve/fix-quote-ui/1724

### Content

Can you all fix the Client Quote View? It would cause less confusion if optional line items were marked as "optional" as seen in the admin view and if those options were also offset to the right, as seen in the admin view. Not having these two simple things makes those items not seem "optional".
...
Hey Boardwalk, thanks for the suggestion. From the client's view, the line items do indicate that they are "Not Included," but I think having the words "Optional" would be beneficial as well! I have submitted this feedback to our Product Team; thanks for sharing it. While I can not guarantee updates, we value our customers' feedback so we can continue to improve.
...
Additionally, include a line such as "Click here to add this item to your service" or something similar to remind the client to select the item to ensure it is completed by the company.

---

## 33. Am I crazy? Need help.

**Author:** JustinDucharme (Contributor 2)
**Posted:** 2025-02-27
**Views:** 203 | **Likes:** 1 | **Comments:** 5
**URL:** https://community.getjobber.com/discussions/customer-management-and-self-serve/am-i-crazy-need-help-/1431

### Content

Hey guys, wondering is anyone has any insight or ideas. Very frustrated and Jobber support is not helping. I am trying to remove 2 factor authentication for a few reasons: 1) to get into Jobber as I have virtual assistants that need to get into the account at different times that live in different countries. I can't be sitting by my phone at all times waiting for codes. I called Jobber support to ask for a solution. Their response was to have all different authorized users have their own profile. So I have to pay an extra $60/month to make sure everybody can authenticate from their own phone #. What if I was a big business and I had 20 assistants in and out of the software. We would have to have an entire department for 2FA code support.. crazy. Apparently it's impossible to remove 2FA. 2) I am a team trying to set up automations for a highlevel form to transfer the info and book the job into jobber using API's and all types of fancy stuff. However the 2FA might make this impossible for reasons I am not smart enough to explain. This seems a normal thing that growing businesses in 2024 would be implementing to make less manual work. Not looking to just complain, wondering if anyone knows any higher ups in Jobber or a way to figure this out? Surely there is other people with these problems. I am sure not every person that uses jobber is a 1 man show business..
...
I work virtually with my clients and if everyone has their own login you won't have issues. If everyone is using the same login from different locations it triggers the 2FA. Do your VA's have a separate login? There is a lot of information stored within Jobber and it should be protected. I don't love the 2FA but I do understand why it was implemented.

#### Reply 2

**Author:** JustinDucharme
**Posted:** 2025-02-27
...
Ultimately this is a cost you need to pass along to your clients. Keeping your data secure shouldn't be overlooked IMO
...
I can’t imagine this is accurate. I don’t have 2 factor authentication on my jobber, and I have 28 employees who all have their own access and login. Not sure about pricing but if it’s only $60 extra per month to get your growing business on jobber, it’s worth the money. It also allows you to set permissions per employee which is important. As an owner you shouldn’t allow all employees who login under you to have access to everything you have access to as an admin. I hope this helps!
...
to TheProcessCEO Got it figured out by creating a second admin account. Not sure why I didn’t think that. Jobber support was actually super helpful in helping me out

---

## 34. Hold Harmless Agreement

**Author:** Woody (Contributor 2)
**Posted:** 2025-02-27
**Views:** 138 | **Likes:** 0 | **Comments:** 2
**URL:** https://community.getjobber.com/discussions/customer-management-and-self-serve/hold-harmless-agreement/1802

### Content

Is there a way to add or incorporate a Hold Harmless Agreement onto a job and have the customer sign it prior to beginning the job? I thought I might be able to make a job form that attaches to each job, but I cannot seem to figure out how to accomplish this task. Thank you! CLIENT HUB CLIENT MANAGER
...
You can apply that into the Terms & Conditions section of Jobber. Go into Branding and apply it there.
...
Under Settings -> Branding -> Change PDF Style -> Jobs there is the option to print a pdf of a job and there is a space for verbiage and a signature line. When you are on the job screen you can go to the more actions menu and download or print the pdf and it serves as a work order or bill of lading. I don't know if there is a way to digitally sign it but if you don't mind printing it off and sending it to the job site it is an option.

---

## 35. Help w/ iPhone App

**Author:** LuminaryLawns (Contributor 2)
**Posted:** 2025-02-27
**Views:** 106 | **Likes:** 1 | **Comments:** 3
**URL:** https://community.getjobber.com/discussions/customer-management-and-self-serve/help-w-iphone-app/1759

### Content

Does anyone know how to clear notifications on the Jobber iPhone app? Alternatively, is there a way to forward any messages to our jobber phone number to another service? I can never tell when I get a new message from a customer because it always says I have a notification on my app screen. I have gone in and scrolled through all notifications, I’ve clicked on them, still shows this bubble on the Home Screen. Thanks in advance! jade Hey Luminary Lawns Team! Thanks for your question. Jobber does not currently allow you to forward messages from your DPN to another number, but I would be happy to submit that as a feature request. As for that stuck notification, this is something that we have run into before. The following steps should resolve the issue: 1. Open Jobber Online (web not app) 2. Mark two messages as unread 3. Open the app and see there are 2 unread messages (do not tap on them yet) 4. Close the app and ensure the icon now says 2 unread messages (this is the important part, we want the badge to move from 1 > 2 > 0, not from 1 > 0) 5. Open the app and read both of the messages 6. The notification badge should disappear now If after completing these steps the notification will not clear, please call our Success Team at 888-721-1115 ext 1.
...
Have you tried checking with Jobber Support on this??
...
Hey Luminary Lawns Team! Thanks for your question. Jobber does not currently allow you to forward messages from your DPN to another number, but I would be happy to submit that as a feature request. As for that stuck notification, this is something that we have run into before. The following steps should resolve the issue: 1. Open Jobber Online (web not app) 2. Mark two messages as unread 3. Open the app and see there are 2 unread messages (do not tap on them yet) 4. Close the app and ensure the icon now says 2 unread messages (this is the important part, we want the badge to move from 1 > 2 > 0, not from 1 > 0) 5. Open the app and read both of the messages 6. The notification badge should disappear now If after completing these steps the notification will not clear, please call our Success Team at 888-721-1115 ext 1.
...
to jade I appreciate the . Now I'm stuck w/ a bubble that says 2 haha, I'll call the Success Team

---

## 36. Client hub options

**Author:** Joeltricitypool (Contributor 2)
**Posted:** 2025-02-27
**Views:** 127 | **Likes:** 1 | **Comments:** 2
**URL:** https://community.getjobber.com/discussions/customer-management-and-self-serve/client-hub-options/1259

### Content

Is there a way to for my customers to pull up job forums that have been completed in client hub ? I’m a weekly pool service contractor. We send out pictures and complete job forms to our customers each visit. I know they have the emails, but is there a way to file these so they could see these on client hub ? Right now I’m messing around with saving the job forms email it sends to the customer and filing it away in a google document that’s shareable . Then I’m creating a specific QR code for that file labeled for the particular customer. I can then send that as an attachment on the monthly invoice, but I doubt they will open it. Thank you, Joel CLIENT HUB
...
Your current process is so detailed - I love that!! Great suggestion 😎
...
Does it need to be within Jobber..? I understand wanting to keep everything in one place, but I feel that there's better ways to manage bulk photos, notes etc. as Jobber is a CRM and great at that, trying to turn it into a content library, well... I don't think any CRM would be good at that. That's why Company Cam is so good. (I haven't used it, but it definitely looks the most slick solution available.) I've also thought of setting up a Discord business channel, with different chats for each property, you could pin photos, videos etc. and it's all easily searchable etc. I do use notes in Jobber, but they have a specific purpose for action items (eg. additional tasks for the next visit), or are related to specific Jobber functions quoting, invoicing, etc. (eg, notes for total lawn area used for quoting spray applications, lawn renovations, etc.)

#### Reply 2

**Author:** Morningstarpb
**Posted:** 2025-02-27

When will Jobber AI receptionist be ready to use?
...
JOBBER COMMUNITY TEAM to Morningstarpb Jobber AI Receptionist is currently in a limited access beta phase! If you are interested in trying it out, join the Jobber AI Receptionist waitlist here.
...
to Morningstarpb Yeah I think the CoPilot will be able to help with this a bit. I am not sure though! Sorry.
...
I think this would have some value depending on the business and workflows. Today, I’m using Jobber and HubSpot. Why, HubSpot offers more robust CRM features you have mentioned above. I’m pretty sure you have an option to save almost any popular file format to HubSpot as a note or just an attachment.
...
Yes, I built something similar using the API last year and I'm putting it out on the marketplace. It's nice in the client record because then every voicemail from that phone number is in one place. We also use AI to scan the voicemail first so that the junk and SPAM isn't uploaded because we started getting expired car warranty, google ads resellers and website companies clogging up our jobber. Message me if you want to try it and give me feedback.

---

## 38. Archive Properties

**Author:** Mullins (Contributor 2)
**Posted:** 2025-02-27
**Views:** 102 | **Likes:** 3 | **Comments:** 1
**URL:** https://community.getjobber.com/discussions/customer-management-and-self-serve/archive-properties/708

### Content

Hey I think it would be great if you could merge and archive Properties. Occasionally we have a client hit the new customer request button and create a second property for the already existing customer. It would be great if we could merge these properties since they are the same. We have a large amount of history for many properties under a contractor who hires us as a sub and we do not want to lose the history however when we take over the account and start billing the homeowner for continued service we would to archive the property under the contractor that had us do the original work. Under the contractor we have a large amount of properties and their information because we are bidding many jobs per year. Any thoughts?
